    ...
    [830], {
        3221: function(e, t, r) {
            ...
            let ParseError = class ParseError {
                constructor(e, t) {
                    ...
                    var r = "KaTeX parse error: " + e,
                        n = t && t.loc;
                    if (n && n.start <= n.end) {
                        var a, i, o = n.lexer.input;
                        a = n.start, i = n.end, a === o.length ? r += " at end of input: " : r += " at position " + (a + 1) + ": ";
                        var l = o.slice(a, i).replace(/[^]/g, "$&̲");
                        r += (a > 15 ? "…" + o.slice(a - 15, a) : o.slice(0, a)) + l + (i + 15 < o.length ? o.slice(i, i + 15) + "…" : o.slice(i))
                    }
                    var s = Error(r);
                    return s.name = "ParseError", s.__proto__ = ParseError.prototype, s.position = a, null != a && null != i && (s.length = i - a), s.rawMessage = e, s
                }
            };
            ...
            var n, a, i = /([A-Z])/g,
                ...
                l = /[&><"']/g,
                getBaseElem = function getBaseElem(e) {
                ...
                s = {
                    ...
                    escape: function(e) {
                        return String(e).replace(l, e => o[e])
                    },
            ...
            let Settings = class Settings {
                ...
                reportNonstrict(e, t, r) {
                    ...
                    if ("function" == typeof n && (n = n(e, t, r)), n && "ignore" !== n) {
                        if (!0 === n || "error" === n) throw new ParseError("LaTeX-incompatible input and strict mode is set to 'error': " + t + " [" + e + "]", r);
                ...
                isTrusted(e) {
                    return e.url && !e.protocol && (e.protocol = s.protocolFromUrl(e.url)), !!("function" == typeof this.trust ? this.trust(e) : this.trust)
                }
            };
            ...
            var h = [new Style(0, 0, !1), new Style(1, 0, !0), new Style(2, 1, !1), new Style(3, 1, !0), new Style(4, 2, !1), new Style(5, 2, !0), new Style(6, 3, !1), new Style(7, 3, !0)],
                d = [4, 5, 4, 5, 6, 7, 6, 7],
                c = [5, 5, 5, 5, 7, 7, 7, 7],
                u = [2, 3, 4, 5, 6, 7, 6, 7],
                p = [3, 3, 5, 5, 7, 7, 7, 7],
            ...
            function getCharacterMetrics(e, t, r) {
                if (!x[t]) throw Error("Font metrics not found for font: " + t + ".");
                var n = e.charCodeAt(0),
                    a = x[t][n];
                if (!a && e[0] in k && (n = k[e[0]].charCodeAt(0), a = x[t][n]), !a && "text" === r && supportedCodepoint(n) && (a = x[t][77]), a) return {
                    depth: a[0],
                    height: a[1],
                    italic: a[2],
                    skew: a[3],
            ...
            let Options = class Options {
                constructor(e) {
                    this.style = void 0, this.color = void 0, this.size = void 0, this.textSize = void 0, this.phantom = void 0, this.font = void 0, this.fontFamily = void 0, this.fontWeight = void 0, this.fontShape = void 0, this.sizeMultiplier = void 0, this.maxSize = void 0, this.minRuleThickness = void 0, this._fontMetrics = void 0, this.style = e.style, this.color = e.color, this.size = e.size || Options.BASESIZE, this.textSize = e.textSize || this.size, this.phantom = !!e.phantom, this.font = e.font || "", this.fontFamily = e.fontFamily || "", this.fontWeight = e.fontWeight || "", this.fontShape = e.fontShape || "", this.sizeMultiplier = T[this.size - 1], this.maxSize = e.maxSize, this.minRuleThickness = e.minRuleThickness, this._fontMetrics = void 0
                }
                extend(e) {
                    var t = {
                        style: this.style,
                ...
                havingBaseStyle(e) {
                    e = e || this.style.text();
                    var t = sizeAtStyle(Options.BASESIZE, e);
                ...
                fontMetrics() {
                    return this._fontMetrics || (this._fontMetrics = function(e) {
                        var t;
                        if (!M[t = e >= 5 ? 0 : e >= 3 ? 1 : 2]) {
                            var r = M[t] = {
                                cssEmPerMu: w.quad[t] / 18
                            };
                            for (var n in w) w.hasOwnProperty(n) && (r[n] = w[n][t])
                        }
                        return M[t]
            ...
            var A = {
                ...
                validUnit = function(e) {
                    return "string" != typeof e && (e = e.unit), e in A || e in E || "ex" === e
                },
                ...
                toNode = function(e) {
                    ...
                    for (var r in t.className = createClass(this.classes), this.style) this.style.hasOwnProperty(r) && (t.style[r] = this.style[r]);
                ...
                toMarkup = function(e) {
                    var t = "<" + e;
                    this.classes.length && (t += ' class="' + s.escape(createClass(this.classes)) + '"');
                    var r = "";
                    for (var n in this.style) this.style.hasOwnProperty(n) && (r += s.hyphenate(n) + ":" + this.style[n] + ";");
                    for (var a in r && (t += ' style="' + s.escape(r) + '"'), this.attributes) this.attributes.hasOwnProperty(a) && (t += " " + a + '="' + s.escape(this.attributes[a]) + '"');
                    t += ">";
            ...
            let Span = class Span {
                constructor(e, t, r, n) {
                    this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.width = void 0, this.maxFontSize = void 0, this.style = void 0, initNode.call(this, e, r, n), this.children = t || []
                }
                setAttribute(e, t) {
                    this.attributes[e] = t
                }
            ...
            let Anchor = class Anchor {
                constructor(e, t, r, n) {
                    this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.maxFontSize = void 0, this.style = void 0, initNode.call(this, t, n), this.children = r || [], this.setAttribute("href", e)
                }
                setAttribute(e, t) {
                    this.attributes[e] = t
                }
            ...
            let SymbolNode = class SymbolNode {
                constructor(e, t, r, n, a, i, o, l) {
                    this.text = void 0, this.height = void 0, this.depth = void 0, this.italic = void 0, this.skew = void 0, this.width = void 0, this.maxFontSize = void 0, this.classes = void 0, this.style = void 0, this.text = e, this.height = t || 0, this.depth = r || 0, this.italic = n || 0, this.skew = a || 0, this.width = i || 0, this.classes = o || [], this.style = l || {}, this.maxFontSize = 0;
                    var s = function(e) {
                    ...
                    s && this.classes.push(s + "_fallback"), /[îïíì]/.test(this.text) && (this.text = B[this.text])
                }
                hasClass(e) {
                    return s.contains(this.classes, e)
                }
                toNode() {
                    var e = document.createTextNode(this.text),
                        t = null;
                    for (var r in this.italic > 0 && ((t = document.createElement("span")).style.marginRight = makeEm(this.italic)), this.classes.length > 0 && ((t = t || document.createElement("span")).className = createClass(this.classes)), this.style) this.style.hasOwnProperty(r) && ((t = t || document.createElement("span")).style[r] = this.style[r]);
                    return t ? (t.appendChild(e), t) : e
                }
                toMarkup() {
                    var e = !1,
                        t = "<span";
                    this.classes.length && (e = !0, t += ' class="' + s.escape(createClass(this.classes)) + '"');
                    var r = "";
            ...
            function defineSymbol(e, t, r, n, a, i) {
                q[e][a] = {
                    font: t,
                    group: r,
                    replace: n
            ...
            defineSymbol(F, H, U, "–", "--", !0), defineSymbol(F, H, U, "–", "\\textendash"), defineSymbol(F, H, U, "—", "---", !0), defineSymbol(F, H, U, "—", "\\textemdash"), defineSymbol(F, H, U, "‘", "`", !0), defineSymbol(F, H, U, "‘", "\\textquoteleft"), defineSymbol(F, H, U, "’", "'", !0), defineSymbol(F, H, U, "’", "\\textquoteright"), defineSymbol(F, H, U, "“", "``", !0), defineSymbol(F, H, U, "“", "\\textquotedblleft"), defineSymbol(F, H, U, "”", "''", !0), defineSymbol(F, H, U, "”", "\\textquotedblright"), defineSymbol(P, H, U, "\xb0", "\\degree", !0), defineSymbol(F, H, U, "\xb0", "\\degree"), defineSymbol(F, H, U, "\xb0", "\\textdegree", !0), defineSymbol(P, H, U, "\xa3", "\\pounds"), defineSymbol(P, H, U, "\xa3", "\\mathsterling", !0), defineSymbol(F, H, U, "\xa3", "\\pounds"), defineSymbol(F, H, U, "\xa3", "\\textsterling", !0), defineSymbol(P, "ams", U, "✠", "\\maltese"), defineSymbol(F, "ams", U, "✠", "\\maltese");
            for (var W = '0123456789/@."', X = 0; X < W.length; X++) {
                var _ = W.charAt(X);
                defineSymbol(P, H, U, _, _)
            }
            for (var j = '0123456789!@*()-=+";:?/.,', Z = 0; Z < j.length; Z++) {
                var K = j.charAt(Z);
                defineSymbol(F, H, U, K, K)
            }
            for (var J = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", Q = 0; Q < J.length; Q++) {
                var ee = J.charAt(Q);
                defineSymbol(P, H, L, ee, ee), defineSymbol(F, H, U, ee, ee)
            }
            defineSymbol(P, "ams", U, "C", "ℂ"), defineSymbol(F, "ams", U, "C", "ℂ"), defineSymbol(P, "ams", U, "H", "ℍ"), defineSymbol(F, "ams", U, "H", "ℍ"), defineSymbol(P, "ams", U, "N", "ℕ"), defineSymbol(F, "ams", U, "N", "ℕ"), defineSymbol(P, "ams", U, "P", "ℙ"), defineSymbol(F, "ams", U, "P", "ℙ"), defineSymbol(P, "ams", U, "Q", "ℚ"), defineSymbol(F, "ams", U, "Q", "ℚ"), defineSymbol(P, "ams", U, "R", "ℝ"), defineSymbol(F, "ams", U, "R", "ℝ"), defineSymbol(P, "ams", U, "Z", "ℤ"), defineSymbol(F, "ams", U, "Z", "ℤ"), defineSymbol(P, H, L, "h", "ℎ"), defineSymbol(F, H, L, "h", "ℎ");
            for (var et = "", er = 0; er < J.length; er++) {
                var en = J.charAt(er);
                defineSymbol(P, H, L, en, et = String.fromCharCode(55349, 56320 + er)), defineSymbol(F, H, U, en, et), defineSymbol(P, H, L, en, et = String.fromCharCode(55349, 56372 + er)), defineSymbol(F, H, U, en, et), defineSymbol(P, H, L, en, et = String.fromCharCode(55349, 56424 + er)), defineSymbol(F, H, U, en, et), defineSymbol(P, H, L, en, et = String.fromCharCode(55349, 56580 + er)), defineSymbol(F, H, U, en, et), defineSymbol(P, H, L, en, et = String.fromCharCode(55349, 56684 + er)), defineSymbol(F, H, U, en, et), defineSymbol(P, H, L, en, et = String.fromCharCode(55349, 56736 + er)), defineSymbol(F, H, U, en, et), defineSymbol(P, H, L, en, et = String.fromCharCode(55349, 56788 + er)), defineSymbol(F, H, U, en, et), defineSymbol(P, H, L, en, et = String.fromCharCode(55349, 56840 + er)), defineSymbol(F, H, U, en, et), defineSymbol(P, H, L, en, et = String.fromCharCode(55349, 56944 + er)), defineSymbol(F, H, U, en, et), er < 26 && (defineSymbol(P, H, L, en, et = String.fromCharCode(55349, 56632 + er)), defineSymbol(F, H, U, en, et), defineSymbol(P, H, L, en, et = String.fromCharCode(55349, 56476 + er)), defineSymbol(F, H, U, en, et))
            }
            defineSymbol(P, H, L, "k", et = String.fromCharCode(55349, 56668)), defineSymbol(F, H, U, "k", et);
            for (var ea = 0; ea < 10; ea++) {
                var ei = ea.toString();
                defineSymbol(P, H, L, ei, et = String.fromCharCode(55349, 57294 + ea)), defineSymbol(F, H, U, ei, et), defineSymbol(P, H, L, ei, et = String.fromCharCode(55349, 57314 + ea)), defineSymbol(F, H, U, ei, et), defineSymbol(P, H, L, ei, et = String.fromCharCode(55349, 57324 + ea)), defineSymbol(F, H, U, ei, et), defineSymbol(P, H, L, ei, et = String.fromCharCode(55349, 57334 + ea)), defineSymbol(F, H, U, ei, et)
            }
            for (var eo = "\xd0\xde\xfe", el = 0; el < eo.length; el++) {
                var es = eo.charAt(el);
                defineSymbol(P, H, L, es, es), defineSymbol(F, H, U, es, es)
            }
            var em = [
                ...
                wideCharacterFont = function(e, t) {
                    ...
                    if (119808 <= r && r < 120484) {
                        ...
                        return [em[a][2], em[a][n]]
                    }
                    if (120782 <= r && r <= 120831) {
                        var i = Math.floor((r - 120782) / 10);
                        return [eh[i][2], eh[i][n]]
                    }
                    if (120485 === r || 120486 === r) return [em[0][2], em[0][n]];
                    if (120486 < r && r < 120782) return ["", ""];
                    throw new ParseError("Unsupported character: " + e)
                },
                lookupSymbol = function(e, t, r) {
                    return q[r][e] && q[r][e].replace && (e = q[r][e].replace), {
                        value: e,
                        metrics: getCharacterMetrics(e, t, r)
                    }
                },
                makeSymbol = function(e, t, r, n, a) {
                    var i, o = lookupSymbol(e, t, r),
                        l = o.metrics;
                    if (e = o.value, l) {
                        var s = l.italic;
                        ("text" === r || n && "mathit" === n.font) && (s = 0), i = new SymbolNode(e, l.height, l.depth, s, l.skew, l.width, a)
                    } else "undefined" != typeof console && console.warn("No character metrics " + ("for '" + e + "' in style '" + t) + "' and mode '" + r + "'"), i = new SymbolNode(e, 0, 0, 0, 0, 0, a);
                    if (n) {
                ...
                makeSpan$2 = function(e, t, r, n) {
                    var a = new Span(e, t, r, n);
                    return sizeElementFromChildren(a), a
                },
                makeSvgSpan = (e, t, r, n) => new Span(e, t, r, n),
                ...
                getVListChildrenAndDepth = function(e) {
                    if ("individualShift" === e.positionType) {
                        for (var t, r = e.children, n = [r[0]], a = -r[0].shift - r[0].elem.depth, i = a, o = 1; o < r.length; o++) {
                            var l = -r[o].shift - i - r[o].elem.depth,
                                s = l - (r[o - 1].elem.height + r[o - 1].elem.depth);
                            i += l, n.push({
                                type: "kern",
                                size: s
                            }), n.push(r[o])
                    ...
                    if ("top" === e.positionType) {
                        for (var m = e.positionData, h = 0; h < e.children.length; h++) {
                            var d = e.children[h];
                            m -= "kern" === d.type ? d.size : d.elem.height + d.elem.depth
                        }
                        t = m
                    } else if ("bottom" === e.positionType) t = -e.positionData;
                    else {
                        var c = e.children[0];
                        if ("elem" !== c.type) throw Error('First child must have type "elem".');
                        if ("shift" === e.positionType) t = -c.elem.depth - e.positionData;
                        else if ("firstBaseline" === e.positionType) t = -c.elem.depth;
                ...
                retrieveTextFontName = function(e, t, r) {
                    var n = "";
                    switch (e) {
                        case "amsrm":
                            n = "AMS";
                ...
                eu = {
                    ...
                    mathsym: function(e, t, r, n) {
                        return (void 0 === n && (n = []), "boldsymbol" === r.font && lookupSymbol(e, "Main-Bold", t).metrics) ? makeSymbol(e, "Main-Bold", t, r, n.concat(["mathbf"])) : "\\" === e || "main" === q[t][e].font ? makeSymbol(e, "Main-Regular", t, r, n) : makeSymbol(e, "AMS-Regular", t, r, n.concat(["amsrm"]))
                    },
                    makeSpan: makeSpan$2,
                    makeSvgSpan,
                    makeLineSpan: function(e, t, r) {
                        var n = makeSpan$2([e], [], t);
                        return n.height = Math.max(r || t.fontMetrics().defaultRuleThickness, t.minRuleThickness), n.style.borderBottomWidth = makeEm(n.height), n.maxFontSize = 1, n
                    },
                    makeAnchor: function(e, t, r, n) {
                        var a = new Anchor(e, t, r, n);
                        return sizeElementFromChildren(a), a
                    },
                    makeFragment,
                    ...
                    makeVList: function(e, t) {
                        for (var r, {
                                children: n,
                                depth: a
                            } = getVListChildrenAndDepth(e), i = 0, o = 0; o < n.length; o++) {
                            var l = n[o];
                            if ("elem" === l.type) {
                                var s = l.elem;
                        ...
                        i += 2;
                        var m = makeSpan$2(["pstrut"], []);
                        m.style.height = makeEm(i);
                        for (var h = [], d = a, c = a, u = a, p = 0; p < n.length; p++) {
                            var f = n[p];
                            if ("kern" === f.type) u += f.size;
                            else {
                                var b = f.elem,
                                    g = makeSpan$2(f.wrapperClasses || [], [m, b], void 0, f.wrapperStyle || {});
                                g.style.top = makeEm(-i - u - b.depth), f.marginLeft && (g.style.marginLeft = f.marginLeft), f.marginRight && (g.style.marginRight = f.marginRight), h.push(g), u += b.height + b.depth
                            }
                            d = Math.min(d, u), c = Math.max(c, u)
                        }
                        var y = makeSpan$2(["vlist"], h);
                        if (y.style.height = makeEm(c), d < 0) {
                            var v = makeSpan$2([], []),
                                S = makeSpan$2(["vlist"], [v]);
                            S.style.height = makeEm(-d);
                            var x = makeSpan$2(["vlist-s"], [new SymbolNode("​")]);
                            r = [makeSpan$2(["vlist-r"], [y, x]), makeSpan$2(["vlist-r"], [S])]
                        } else r = [makeSpan$2(["vlist-r"], [y])];
                        var w = makeSpan$2(["vlist-t"], r);
                        return 2 === r.length && w.classes.push("vlist-t2"), w.height = c, w.depth = -d, w
                    },
                    makeOrd: function(e, t, r) {
                        var n = e.mode,
                            ...
                            s = "",
                            m = "";
                        if (55349 === a.charCodeAt(0) && ([s, m] = wideCharacterFont(a, n)), s.length > 0) return makeSymbol(a, s, n, t, i.concat(m));
                        if (l) {
                            if ("boldsymbol" === l) {
                                var h, d, c = "textord" !== r && lookupSymbol(a, "Math-BoldItalic", n).metrics ? {
                                ...
                                h = c.fontName, d = [c.fontClass]
                            } else o ? (h = ed[l].fontName, d = [l]) : (h = retrieveTextFontName(l, t.fontWeight, t.fontShape), d = [l, t.fontWeight, t.fontShape]);
                            if (lookupSymbol(a, h, n).metrics) return makeSymbol(a, h, n, t, i.concat(d));
                            if (Y.hasOwnProperty(a) && "Typewriter" === h.slice(0, 10)) {
                                for (var u = [], p = 0; p < a.length; p++) u.push(makeSymbol(a[p], h, n, t, i.concat(d)));
                                return makeFragment(u)
                            }
                        }
                        if ("mathord" === r) return makeSymbol(a, "Math-Italic", n, t, i.concat(["mathnormal"]));
                        if ("textord" === r) {
                            var f = q[n][a] && q[n][a].font;
                            if ("ams" === f) return makeSymbol(a, retrieveTextFontName("amsrm", t.fontWeight, t.fontShape), n, t, i.concat("amsrm", t.fontWeight, t.fontShape));
                            if ("main" === f || !f) return makeSymbol(a, retrieveTextFontName("textrm", t.fontWeight, t.fontShape), n, t, i.concat(t.fontWeight, t.fontShape));
                            var b = retrieveTextFontName(f, t.fontWeight, t.fontShape);
                            return makeSymbol(a, b, n, t, i.concat(b, t.fontWeight, t.fontShape))
                        }
                        throw Error("unexpected type: " + r + " in makeOrd")
                    },
                    makeGlue: (e, t) => {
                        var r = makeSpan$2(["mspace"], [], t),
                            n = calculateSize(e, t);
                        return r.style.marginRight = makeEm(n), r
                    },
                    staticSvg: function(e, t) {
                        var [r, n, a] = ec[e], i = new PathNode(r), o = makeSvgSpan(["overlay"], [new SvgNode([i], {
                            width: makeEm(n),
                            height: makeEm(a),
                            style: "width:" + makeEm(n),
                            viewBox: "0 0 " + 1e3 * n + " " + 1e3 * a,
                            preserveAspectRatio: "xMinYMin"
                        })], t);
                        return o.height = a, o.style.height = makeEm(a), o.style.width = makeEm(n), o
                    },
                    svgData: ec,
                    tryCombineChars: e => {
            ...
            var normalizeArgument = function(e) {
                ...
                ew = eu.makeSpan,
                ek = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"],
                eM = ["rightmost", "mrel", "mclose", "mpunct"],
                ez = {
                    display: g.DISPLAY,
                    text: g.TEXT,
                    script: g.SCRIPT,
                ...
                buildExpression$1 = function(e, t, r, n) {
                    void 0 === n && (n = [null, null]);
                    for (var a = [], i = 0; i < e.length; i++) {
                        var o = buildGroup$1(e[i], t);
                        if (o instanceof DocumentFragment) {
                            var l = o.children;
                            a.push(...l)
                        } else a.push(o)
                    }
                    if (eu.tryCombineChars(a), !r) return a;
                    var m = t;
                    if (1 === e.length) {
                        var h = e[0];
                        "sizing" === h.type ? m = t.havingSize(h.size) : "styling" === h.type && (m = t.havingStyle(ez[h.style]))
                    }
                    var d = ew([n[0] || "leftmost"], [], t),
                        c = ew([n[1] || "rightmost"], [], t),
                        u = "root" === r;
                    return traverseNonSpaceNodes(a, (e, t) => {
                        var r = t.classes[0],
                            n = e.classes[0];
                        "mbin" === r && s.contains(eM, n) ? t.classes[0] = "mord" : "mbin" === n && s.contains(ek, r) && (e.classes[0] = "mord")
                    }, {
                        node: d
                    }, c, u), traverseNonSpaceNodes(a, (e, t) => {
                        var r = getTypeOfDomTree(t),
                            n = getTypeOfDomTree(e),
                            a = r && n ? e.hasClass("mtight") ? ey[r][n] : eg[r][n] : null;
                        if (a) return eu.makeGlue(a, m)
                    }, {
                        node: d
                    }, c, u), a
                },
                traverseNonSpaceNodes = function traverseNonSpaceNodes(e, t, r, n, a) {
                    n && e.push(n);
                    for (var i = 0; i < e.length; i++) {
                        var o, l = e[i],
                            s = checkPartialGroup(l);
                        if (s) {
                            traverseNonSpaceNodes(s.children, t, r, null, a);
                            continue
                        }
                        ...
                        m ? r.node = l : a && l.hasClass("newline") && (r.node = ew(["leftmost"])), r.insertAfter = (o = i, t => {
                            e.splice(o + 1, 0, t), i++
                        })
                    }
                    n && e.pop()
                ...
                getOutermostNode = function getOutermostNode(e, t) {
                    var r = checkPartialGroup(e);
                    if (r) {
                        var n = r.children;
                        if (n.length) {
                ...
                getTypeOfDomTree = function(e, t) {
                    return e ? (t && (e = getOutermostNode(e, t)), eT[e.classes[0]] || null) : null
                },
                makeNullDelimiter = function(e, t) {
                    var r = ["nulldelimiter"].concat(e.baseSizingClasses());
                    return ew(t.concat(r))
                },
            ...
            function buildHTMLUnbreakable(e, t) {
                var r = ew(["base"], e, t),
                    n = ew(["strut"]);
                return n.style.height = makeEm(r.height + r.depth), r.depth && (n.style.verticalAlign = makeEm(-r.depth)), r.children.unshift(n), r
            }

            function buildHTML(e, t) {
                var r, n, a = null;
                1 === e.length && "tag" === e[0].type && (a = e[0].tag, e = e[0].body);
                var i = buildExpression$1(e, t, "root");
                2 === i.length && i[1].hasClass("tag") && (r = i.pop());
                for (var o = [], l = [], s = 0; s < i.length; s++)
                    if (l.push(i[s]), i[s].hasClass("mbin") || i[s].hasClass("mrel") || i[s].hasClass("allowbreak")) {
                ...
                l.length > 0 && o.push(buildHTMLUnbreakable(l, t)), a ? ((n = buildHTMLUnbreakable(buildExpression$1(a, t, !0))).classes = ["tag"], o.push(n)) : r && o.push(r);
                var h = ew(["katex-html"], o);
                if (h.setAttribute("aria-hidden", "true"), n) {
                    var d = n.children[0];
                    d.style.height = makeEm(h.height + h.depth), h.depth && (d.style.verticalAlign = makeEm(-h.depth))
                }
                return h
            }
            ...
            let MathNode = class MathNode {
                ...
                toMarkup() {
                    ...
                    this.classes.length > 0 && (e += ' class ="' + s.escape(createClass(this.classes)) + '"'), e += ">";
                    for (var r = 0; r < this.children.length; r++) e += this.children[r].toMarkup();
                    return e + ("</" + this.type) + ">"
                }
                toText() {
            ...
            var eA = {
                ...
                makeText = function(e, t, r) {
                    return q[t][e] && q[t][e].replace && 55349 !== e.charCodeAt(0) && !(Y.hasOwnProperty(e) && r && (r.fontFamily && "tt" === r.fontFamily.slice(4, 6) || r.font && "tt" === r.font.slice(4, 6))) && (e = q[t][e].replace), new eA.TextNode(e)
                },
                makeRow = function(e) {
                    return 1 === e.length ? e[0] : new eA.MathNode("mrow", e)
                },
                getVariant = function(e, t) {
                    ...
                    var a = e.text;
                    return s.contains(["\\imath", "\\jmath"], a) ? null : (q[n][a] && q[n][a].replace && (a = q[n][a].replace), getCharacterMetrics(a, eu.fontMap[r].fontName, n)) ? eu.fontMap[r].variant : null
                },
                buildExpression = function(e, t, r) {
                    if (1 === e.length) {
                        var n, a = buildGroup(e[0], t);
                        return r && a instanceof MathNode && "mo" === a.type && (a.setAttribute("lspace", "0em"), a.setAttribute("rspace", "0em")), [a]
                    }
                    for (var i = [], o = 0; o < e.length; o++) {
                        var l = buildGroup(e[o], t);
                        if (l instanceof MathNode && n instanceof MathNode) {
                            if ("mtext" === l.type && "mtext" === n.type && l.getAttribute("mathvariant") === n.getAttribute("mathvariant") || "mn" === l.type && "mn" === n.type) {
                                n.children.push(...l.children);
                                continue
                            }
                            if ("mi" === l.type && 1 === l.children.length && "mn" === n.type) {
                                var s = l.children[0];
                                if (s instanceof TextNode && "." === s.text) {
                                    n.children.push(...l.children);
                                    continue
                                }
                                ...
                                if (m instanceof TextNode && "̸" === m.text && ("mo" === l.type || "mi" === l.type || "mn" === l.type)) {
                                    var h = l.children[0];
                                    h instanceof TextNode && h.text.length > 0 && (h.text = h.text.slice(0, 1) + "̸" + h.text.slice(1), i.pop())
                                }
                            }
                        }
                        i.push(l), n = l
                ...
                buildExpressionRow = function(e, t, r) {
                    return makeRow(buildExpression(e, t, r))
                },
                buildGroup = function(e, t) {
                    if (!e) return new eA.MathNode("mrow");
                    if (ex[e.type]) return ex[e.type](e, t);
                    throw new ParseError("Got group of unknown type: '" + e.type + "'")
                };

            function buildMathML(e, t, r, n, a) {
                var i, o = buildExpression(e, r);
                i = 1 === o.length && o[0] instanceof MathNode && s.contains(["mrow", "mtable"], o[0].type) ? o[0] : new eA.MathNode("mrow", o);
                var l = new eA.MathNode("annotation", [new eA.TextNode(t)]);
                l.setAttribute("encoding", "application/x-tex");
                var m = new eA.MathNode("semantics", [i, l]),
                    h = new eA.MathNode("math", [m]);
                return h.setAttribute("xmlns", "http://www.w3.org/1998/Math/MathML"), n && h.setAttribute("display", "block"), eu.makeSpan([a ? "katex" : "katex-mathml"], [h])
            }
            var optionsFromSettings = function(e) {
                ...
                displayWrap = function(e, t) {
                    if (t.displayMode) {
                        var r = ["katex-display"];
                        t.leqno && r.push("leqno"), t.fleqn && r.push("fleqn"), e = eu.makeSpan(r, [e])
                    }
                    return e
                },
                buildTree = function(e, t, r) {
                    var n, a = optionsFromSettings(r);
                    if ("mathml" === r.output) return buildMathML(e, t, a, r.displayMode, !0);
                    if ("html" === r.output) {
                        var i = buildHTML(e, a);
                        n = eu.makeSpan(["katex"], [i])
                    } else {
                        var o = buildMathML(e, t, a, r.displayMode, !1),
                            l = buildHTML(e, a);
                        n = eu.makeSpan(["katex"], [o, l])
                    }
                    return displayWrap(n, r)
                },
                buildHTMLTree = function(e, t, r) {
                    var n = buildHTML(e, optionsFromSettings(r));
                    return displayWrap(eu.makeSpan(["katex"], [n]), r)
                },
                eE = {
                    widehat: "^",
                    widecheck: "ˇ",
                ...
                eN = {
                    encloseSpan: function(e, t, r, n, a) {
                        ...
                        if (/fbox|color|angl/.test(t)) {
                            if (i = eu.makeSpan(["stretchy", t], [], a), "fbox" === t) {
                                var l = a.color && a.getColor();
                                l && (i.style.borderColor = l)
                            }
                        } else {
                            var s = [];
                            ...
                            i = eu.makeSvgSpan([], [m], a)
                        }
                        return i.height = o, i.style.height = makeEm(o), i
                    },
                    mathMLnode: function(e) {
                        var t = new eA.MathNode("mo", [new eA.TextNode(eE[e.replace(/^\\/, "")])]);
                    ...
                    svgSpan: function(e, t) {
                        var {
                            ...
                            var r = 4e5,
                                n = e.label.slice(1);
                            if (s.contains(["widehat", "widecheck", "widetilde", "utilde"], n)) {
                                var a, i, o, l, m = "ordgroup" === (l = e.base).type ? l.body.length : 1;
                                if (m > 5) "widehat" === n || "widecheck" === n ? (a = 420, r = 2364, o = .42, i = n + "4") : (a = 312, r = 2340, o = .34, i = "tilde4");
                                else {
                                    var h = [1, 1, 2, 2, 3, 3][m];
                            ...
                            var u, p, f = [],
                                ...
                                S = v / 1e3,
                                x = g.length;
                            if (1 === x) u = ["hide-tail"], p = [b[3]];
                            else if (2 === x) u = ["halfarrow-left", "halfarrow-right"], p = ["xMinYMin", "xMaxYMin"];
                            else if (3 === x) u = ["brace-left", "brace-center", "brace-right"], p = ["xMinYMin", "xMidYMin", "xMaxYMin"];
                            else throw Error("Correct katexImagesData or update code here to support\n                    " + x + " children.");
                            for (var w = 0; w < x; w++) {
                                var k = new PathNode(g[w]),
                                    M = new SvgNode([k], {
                                        width: "400em",
                                        height: makeEm(S),
                                        viewBox: "0 0 " + r + " " + v,
                                    ...
                                    z = eu.makeSvgSpan([u[w]], [M], t);
                                if (1 === x) return {
                                    span: z,
                                    minWidth: y,
                                    height: S
                                };
                                z.style.height = makeEm(S), f.push(z)
                            }
                            return {
                                span: eu.makeSpan(["stretchy"], f, t),
                                minWidth: y,
                                height: S
                            }
                        }();
                        return r.height = a, r.style.height = makeEm(a), n > 0 && (r.style.minWidth = makeEm(n)), r
                    }
                };
            ...
            function checkSymbolNodeType(e) {
                return e && ("atom" === e.type || C.hasOwnProperty(e.type)) ? e : null
            }
            var htmlBuilder$a = (e, t) => {
                    e && "supsub" === e.type ? (l = (m = assertNodeType(e.base, "accent")).base, e.base = l, h = function(e) {
                    ...
                    var r = buildGroup$1(l, t.havingCrampedStyle()),
                        n = m.isShifty && s.isCharacterBox(l),
                        a = 0;
                    n && (a = assertSymbolDomNode(buildGroup$1(s.getBaseElem(l), t.havingCrampedStyle())).skew);
                    var i = "\\c" === m.label,
                        o = i ? r.height + r.depth : Math.min(r.height, t.fontMetrics().xHeight);
                    if (m.isStretchy) d = eN.svgSpan(m, t), d = eu.makeVList({
                        ...
                        children: [{
                            ...
                            wrapperStyle: a > 0 ? {
                                width: "calc(100% - " + makeEm(2 * a) + ")",
                                marginLeft: makeEm(2 * a)
                            } : void 0
                        }]
                    }, t);
                    else {
                        "\\vec" === m.label ? (c = eu.staticSvg("vec", t), u = eu.svgData.vec[1]) : ((c = assertSymbolDomNode(c = eu.makeOrd({
                            mode: m.mode,
                            text: m.label
                        }, t, "textord"))).italic = 0, u = c.width, i && (o += c.depth)), d = eu.makeSpan(["accent-body"], [c]);
                        var l, m, h, d, c, u, p = "\\textcircled" === m.label;
                        p && (d.classes.push("accent-full"), o = r.height);
                        var f = a;
                        p || (f -= u / 2), d.style.left = makeEm(f), "\\textcircled" === m.label && (d.style.top = ".2em"), d = eu.makeVList({
                            positionType: "firstBaseline",
                            children: [{
                                type: "elem",
                                elem: r
                    ...
                    var b = eu.makeSpan(["mord", "accent"], [d], t);
                    return h ? (h.children[0] = b, h.height = Math.max(b.height, h.height), h.classes[0] = "mord", h) : b
                },
                mathmlBuilder$9 = (e, t) => {
                    var r = e.isStretchy ? eN.mathMLnode(e.label) : new eA.MathNode("mo", [makeText(e.label, e.mode)]),
                        n = new eA.MathNode("mover", [buildGroup(e.base, t), r]);
                    return n.setAttribute("accent", "true"), n
                },
                eC = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map(e => "\\" + e).join("|"));
            defineFunction({
                type: "accent",
                ...
                handler: (e, t) => {
                    var r = normalizeArgument(t[0]),
                        n = !eC.test(e.funcName),
                ...
                htmlBuilder: (e, t) => {
                    ...
                    return eu.makeSpan(["mord", "accentunder"], [i], t)
                },
                mathmlBuilder: (e, t) => {
                    var r = eN.mathMLnode(e.label),
                        n = new eA.MathNode("munder", [buildGroup(e.base, t), r]);
                    return n.setAttribute("accentunder", "true"), n
                }
            });
            var paddedNode = e => {
                var t = new eA.MathNode("mpadded", e ? [e] : []);
            ...
            defineFunction({
                ...
                htmlBuilder(e, t) {
                    var r, n, a = t.style,
                        ...
                        o = eu.wrapFragment(buildGroup$1(e.body, i, t), t),
                        l = "\\x" === e.label.slice(0, 2) ? "x" : "cd";
                    o.classes.push(l + "-arrow-pad"), e.below && (i = t.havingStyle(a.sub()), (r = eu.wrapFragment(buildGroup$1(e.below, i, t), t)).classes.push(l + "-arrow-pad"));
                    var s = eN.svgSpan(e, t),
                        m = -t.fontMetrics().axisHeight + .5 * s.height,
                        h = -t.fontMetrics().axisHeight - .5 * s.height - .111;
                    if ((o.depth > .25 || "\\xleftequilibrium" === e.label) && (h -= o.depth), r) {
                        var d = -t.fontMetrics().axisHeight + r.height + .5 * s.height + .111;
                        n = eu.makeVList({
                    ...
                    return n.children[0].children[0].children[1].classes.push("svg-align"), eu.makeSpan(["mrel", "x-arrow"], [n], t)
                },
                mathmlBuilder(e, t) {
                    var r, n = eN.mathMLnode(e.label);
                    if (n.setAttribute("minsize", "x" === e.label.charAt(0) ? "1.75em" : "3.0em"), e.body) {
                        var a = paddedNode(buildGroup(e.body, t));
                        if (e.below) {
                            var i = paddedNode(buildGroup(e.below, t));
                            r = new eA.MathNode("munderover", [n, i, a])
                        } else r = new eA.MathNode("mover", [n, a])
                    } else if (e.below) {
                        var o = paddedNode(buildGroup(e.below, t));
                        r = new eA.MathNode("munder", [n, o])
                    } else r = paddedNode(), r = new eA.MathNode("mover", [n, r]);
                    return r
                }
            });
            var eq = eu.makeSpan;
            ...
            function mathmlBuilder$8(e, t) {
                var r, n = buildExpression(e.body, t);
                return "minner" === e.mclass ? r = new eA.MathNode("mpadded", n) : "mord" === e.mclass ? e.isCharacterBox ? (r = n[0]).type = "mi" : r = new eA.MathNode("mi", n) : (e.isCharacterBox ? (r = n[0]).type = "mo" : r = new eA.MathNode("mo", n), "mbin" === e.mclass ? (r.attributes.lspace = "0.22em", r.attributes.rspace = "0.22em") : "mpunct" === e.mclass ? (r.attributes.lspace = "0em", r.attributes.rspace = "0.17em") : "mopen" === e.mclass || "mclose" === e.mclass ? (r.attributes.lspace = "0em", r.attributes.rspace = "0em") : "minner" === e.mclass && (r.attributes.lspace = "0.0556em", r.attributes.width = "+0.1111em")), r
            }
            defineFunction({
                type: "mclass",
                ...
                handler(e, t) {
                    ...
                    return {
                        ...
                        mclass: "m" + n.slice(5),
                        body: ordargument(a),
                        isCharacterBox: s.isCharacterBox(a)
                    }
                },
            ...
            defineFunction({
                ...
                handler(e, t) {
                    var r, {
                        ...
                        i = t[1],
                        o = t[0];
                    r = "\\stackrel" !== a ? binrelClass(i) : "mrel";
                    var l = {
                            type: "op",
                            mode: i.mode,
                            limits: !0,
                ...
                htmlBuilder(e, t) {
                    var r = buildExpression$1(e.body, t, !0),
                        n = eu.makeSpan([e.mclass], r, t);
                    return n.style.textShadow = "0.02em 0.01em 0.04px", n
                },
                mathmlBuilder(e, t) {
                    var r = buildExpression(e.body, t),
                        n = new eA.MathNode("mstyle", r);
            ...
            var eP = {
                ...
                isLabelEnd = (e, t) => ("mathord" === e.type || "atom" === e.type) && e.text === t;
            defineFunction({
                type: "cdlabel",
                ...
                htmlBuilder(e, t) {
                    var r = t.havingStyle(t.style.sup()),
                        n = eu.wrapFragment(buildGroup$1(e.label, r, t), t);
                    return n.classes.push("cd-label-" + e.side), n.style.bottom = makeEm(.8 - n.depth), n.height = 0, n.depth = 0, n
                },
                mathmlBuilder(e, t) {
                    var r = new eA.MathNode("mrow", [buildGroup(e.label, t)]);
                    return (r = new eA.MathNode("mpadded", [r])).setAttribute("width", "0"), "left" === e.side && r.setAttribute("lspace", "-1width"), r.setAttribute("voffset", "0.7em"), (r = new eA.MathNode("mstyle", [r])).setAttribute("displaystyle", "false"), r.setAttribute("scriptlevel", "1"), r
                }
            }), defineFunction({
                type: "cdlabelparent",
                names: ["\\\\cdparent"],
                ...
                htmlBuilder(e, t) {
                    var r = eu.wrapFragment(buildGroup$1(e.fragment, t), t);
                    return r.classes.push("cd-vert-arrow"), r
                },
                mathmlBuilder: (e, t) => new eA.MathNode("mrow", [buildGroup(e.fragment, t)])
            }), defineFunction({
                type: "textord",
                names: ["\\@char"],
                props: {
                ...
                handler(e, t) {
                    for (var r, {
                            parser: n
                        } = e, a = assertNodeType(t[0], "ordgroup").body, i = "", o = 0; o < a.length; o++) i += assertNodeType(a[o], "textord").text;
                    var l = parseInt(i);
            ...
            var htmlBuilder$8 = (e, t) => {
                    ...
                    return eu.makeFragment(r)
                },
                mathmlBuilder$7 = (e, t) => {
                    var r = buildExpression(e.body, t.withColor(e.color)),
                        n = new eA.MathNode("mstyle", r);
            ...
            defineFunction({
                ...
                handler(e, t) {
                    var {
                        parser: r
                    } = e, n = assertNodeType(t[0], "color-token").color, a = t[1];
                    return {
                        type: "color",
                        mode: r.mode,
                        color: n,
                ...
                handler(e, t) {
                    var {
                        parser: r,
                        breakOnTokenText: n
                    } = e, a = assertNodeType(t[0], "color-token").color;
                ...
                handler(e, t, r) {
                    var {
                        parser: n
                    } = e, a = "[" === n.gullet.future().text ? n.parseSizeGroup(!0) : null, i = !n.settings.displayMode || !n.settings.useStrictBehavior("newLineInDisplayMode", "In LaTeX, \\\\ or \\newline does nothing in display mode");
                    return {
                        type: "cr",
                        mode: n.mode,
                        newLine: i,
            ...
            defineFunction({
                ...
                handler(e) {
                    ...
                    t.consumeSpaces();
                    var n = t.fetch();
                    if (eF[n.text]) return ("\\global" === r || "\\\\globallong" === r) && (n.text = eF[n.text]), assertNodeType(t.parseFunction(), "internal");
                ...
                handler(e) {
                    var t, {
                        ...
                        a = r.gullet.popToken(),
                        i = a.text;
                    if (/^(?:[\\{}$&#^_]|EOF)$/.test(i)) throw new ParseError("Expected a control sequence", a);
                    for (var o = 0, l = [
                            []
                        ];
                        "{" !== r.gullet.future().text;)
                        if ("#" === (a = r.gullet.popToken()).text) {
                            if ("{" === r.gullet.future().text) {
                                t = r.gullet.future(), l[o].push("{");
                                break
                            }
                            if (a = r.gullet.popToken(), !/^[1-9]$/.test(a.text)) throw new ParseError('Invalid argument number "' + a.text + '"');
                            if (parseInt(a.text) !== o + 1) throw new ParseError('Argument number "' + a.text + '" out of order');
                            o++, l.push([])
                        } else if ("EOF" === a.text) throw new ParseError("Expected a macro definition");
                    else l[o].push(a.text);
                    var {
                        tokens: s
                    } = r.gullet.consumeArg();
                    return t && s.unshift(t), ("\\edef" === n || "\\xdef" === n) && (s = r.gullet.expandTokens(s)).reverse(), r.gullet.macros.set(i, {
                        tokens: s,
                        numArgs: o,
                        delimiters: l
                    }, n === eF[n]), {
                ...
                handler(e) {
                    var {
                        parser: t,
                        funcName: r
                    } = e, n = checkControlSequence(t.gullet.popToken());
                    t.gullet.consumeSpaces();
                    var a = getRHS(t);
                    return letCommand(t, n, a, "\\\\globallet" === r), {
                        type: "internal",
                        mode: t.mode
                    }
                }
                ...
                handler(e) {
                    var {
                        parser: t,
                        funcName: r
                    } = e, n = checkControlSequence(t.gullet.popToken()), a = t.gullet.popToken(), i = t.gullet.popToken();
                    return letCommand(t, n, i, "\\\\globalfuture" === r), t.gullet.pushToken(i), t.gullet.pushToken(a), {
                        type: "internal",
                        mode: t.mode
                    }
                }
            });
            var getMetrics = function(e, t, r) {
                    var n = getCharacterMetrics(q.math[e] && q.math[e].replace || e, t, r);
                    if (!n) throw Error("Unsupported symbol " + e + " and font size " + t + ".");
                    return n
                },
                styleWrap = function(e, t, r, n) {
                    var a = r.havingBaseStyle(t),
                        i = eu.makeSpan(n.concat(a.sizingClasses(r)), [e], r),
                        o = a.sizeMultiplier / r.sizeMultiplier;
                    return i.height *= o, i.depth *= o, i.maxFontSize = a.sizeMultiplier, i
                },
                centerSpan = function(e, t, r) {
                ...
                makeSmallDelim = function(e, t, r, n, a, i) {
                    var o = styleWrap(eu.makeSymbol(e, "Main-Regular", a, n), t, n, i);
                    return r && centerSpan(o, n, t), o
                },
                makeLargeDelim = function(e, t, r, n, a, i) {
                    var o = eu.makeSymbol(e, "Size" + t + "-Regular", a, n),
                        l = styleWrap(eu.makeSpan(["delimsizing", "size" + t], [o], n), g.TEXT, n, i);
                    return r && centerSpan(l, n, g.TEXT), l
                },
                makeGlyphSpan = function(e, t, r) {
                    var n;
                    return n = "Size1-Regular" === t ? "delim-size1" : "delim-size4", {
                        type: "elem",
                        elem: eu.makeSpan(["delimsizinginner", n], [eu.makeSpan([], [eu.makeSymbol(e, t, r)])])
                    }
                },
                makeInner = function(e, t, r) {
                    var n = x["Size4-Regular"][e.charCodeAt(0)] ? x["Size4-Regular"][e.charCodeAt(0)][4] : x["Size1-Regular"][e.charCodeAt(0)][4],
                        a = new PathNode("inner", innerPath(e, Math.round(1e3 * t))),
                        i = new SvgNode([a], {
                            width: makeEm(n),
                            height: makeEm(t),
                            style: "width:" + makeEm(n),
                        ...
                        o = eu.makeSvgSpan([], [i], r);
                    return o.height = t, o.style.height = makeEm(t), o.style.width = makeEm(n), {
                        type: "elem",
                        elem: o
                    }
                },
                ...
                eR = ["|", "\\lvert", "\\rvert", "\\vert"],
                eI = ["\\|", "\\lVert", "\\rVert", "\\Vert"],
                makeStackedDelim = function(e, t, r, n, a, i) {
                    var o, l, m, h, d = "",
                        c = 0;
                    o = m = h = e, l = null;
                    var u = "Size1-Regular";
                    "\\uparrow" === e ? m = h = "⏐" : "\\Uparrow" === e ? m = h = "‖" : "\\downarrow" === e ? o = m = "⏐" : "\\Downarrow" === e ? o = m = "‖" : "\\updownarrow" === e ? (o = "\\uparrow", m = "⏐", h = "\\downarrow") : "\\Updownarrow" === e ? (o = "\\Uparrow", m = "‖", h = "\\Downarrow") : s.contains(eR, e) ? (m = "∣", d = "vert", c = 333) : s.contains(eI, e) ? (m = "∥", d = "doublevert", c = 556) : "[" === e || "\\lbrack" === e ? (o = "⎡", m = "⎢", h = "⎣", u = "Size4-Regular", d = "lbrack", c = 667) : "]" === e || "\\rbrack" === e ? (o = "⎤", m = "⎥", h = "⎦", u = "Size4-Regular", d = "rbrack", c = 667) : "\\lfloor" === e || "⌊" === e ? (m = o = "⎢", h = "⎣", u = "Size4-Regular", d = "lfloor", c = 667) : "\\lceil" === e || "⌈" === e ? (o = "⎡", m = h = "⎢", u = "Size4-Regular", d = "lceil", c = 667) : "\\rfloor" === e || "⌋" === e ? (m = o = "⎥", h = "⎦", u = "Size4-Regular", d = "rfloor", c = 667) : "\\rceil" === e || "⌉" === e ? (o = "⎤", m = h = "⎥", u = "Size4-Regular", d = "rceil", c = 667) : "(" === e || "\\lparen" === e ? (o = "⎛", m = "⎜", h = "⎝", u = "Size4-Regular", d = "lparen", c = 875) : ")" === e || "\\rparen" === e ? (o = "⎞", m = "⎟", h = "⎠", u = "Size4-Regular", d = "rparen", c = 875) : "\\{" === e || "\\lbrace" === e ? (o = "⎧", l = "⎨", h = "⎩", m = "⎪", u = "Size4-Regular") : "\\}" === e || "\\rbrace" === e ? (o = "⎫", l = "⎬", h = "⎭", m = "⎪", u = "Size4-Regular") : "\\lgroup" === e || "⟮" === e ? (o = "⎧", h = "⎩", m = "⎪", u = "Size4-Regular") : "\\rgroup" === e || "⟯" === e ? (o = "⎫", h = "⎭", m = "⎪", u = "Size4-Regular") : "\\lmoustache" === e || "⎰" === e ? (o = "⎧", h = "⎭", m = "⎪", u = "Size4-Regular") : ("\\rmoustache" === e || "⎱" === e) && (o = "⎫", h = "⎩", m = "⎪", u = "Size4-Regular");
                    var p = getMetrics(o, u, a),
                        f = p.height + p.depth,
                        b = getMetrics(m, u, a),
                        y = b.height + b.depth,
                        v = getMetrics(h, u, a),
                        ...
                        w = 1;
                    if (null !== l) {
                        var k = getMetrics(l, u, a);
                        x = k.height + k.depth, w = 2
                    }
                    var M = f + S + x,
                        z = Math.max(0, Math.ceil((t - M) / (w * y))),
                        T = M + z * w * y,
                    ...
                    if (d.length > 0) {
                        var N = Math.round(1e3 * T),
                            C = tallDelim(d, Math.round(1e3 * (T - f - S))),
                            q = new PathNode(d, C),
                            P = (c / 1e3).toFixed(3) + "em",
                            F = (N / 1e3).toFixed(3) + "em",
                            H = new SvgNode([q], {
                                width: P,
                                height: F,
                                viewBox: "0 0 " + c + " " + N
                            }),
                            R = eu.makeSvgSpan([], [H], n);
                        R.height = N / 1e3, R.style.width = P, R.style.height = F, B.push({
                            type: "elem",
                            elem: R
                        })
                    } else {
                        if (B.push(makeGlyphSpan(h, u, a)), B.push(eH), null === l) B.push(makeInner(m, T - f - S + .016, n));
                        else {
                            var I = (T - f - S - x) / 2 + .016;
                            B.push(makeInner(m, I, n)), B.push(eH), B.push(makeGlyphSpan(l, u, a)), B.push(eH), B.push(makeInner(m, I, n))
                        }
                        B.push(eH), B.push(makeGlyphSpan(o, u, a))
                    }
                    var D = n.havingBaseStyle(g.TEXT),
                        L = eu.makeVList({
                            positionType: "bottom",
                            positionData: E,
                            children: B
                        }, D);
                    return styleWrap(eu.makeSpan(["delimsizing", "mult"], [L], D), g.TEXT, n, i)
                },
                sqrtSvg = function(e, t, r, n, a) {
                    var i = sqrtPath(e, n, r),
                        o = new PathNode(e, i),
                        l = new SvgNode([o], {
                            width: "400em",
                            height: makeEm(t),
                    ...
                    return eu.makeSvgSpan(["hide-tail"], [l], a)
                },
                eD = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "\\surd"],
                eL = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱"],
                eO = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"],
                e$ = [0, 1.2, 1.8, 2.4, 3],
                eG = [{
                    type: "small",
                ...
                traverseSequence = function(e, t, r, n) {
                    for (var a = Math.min(2, 3 - n.style.size), i = a; i < r.length && "stack" !== r[i].type; i++) {
                        var o = getMetrics(e, delimTypeToFont(r[i]), "math"),
                            l = o.height + o.depth;
                        if ("small" === r[i].type && (l *= n.havingBaseStyle(r[i].style).sizeMultiplier), l > t) return r[i]
                    }
                    return r[r.length - 1]
                },
                makeCustomSizedDelim = function(e, t, r, n, a, i) {
                    "<" === e || "\\lt" === e || "⟨" === e ? e = "\\langle" : (">" === e || "\\gt" === e || "⟩" === e) && (e = "\\rangle"), o = s.contains(eO, e) ? eG : s.contains(eD, e) ? eU : eV;
                    var o, l = traverseSequence(e, t, o, n);
                    return "small" === l.type ? makeSmallDelim(e, l.style, r, n, a, i) : "large" === l.type ? makeLargeDelim(e, l.size, r, n, a, i) : makeStackedDelim(e, t, r, n, a, i)
                },
                eY = {
                    sqrtImage: function(e, t) {
                        var r, n, a = t.havingBaseSizing(),
                            i = traverseSequence("\\surd", e * a.sizeMultiplier, eU, a),
                            o = a.sizeMultiplier,
                            l = Math.max(0, t.minRuleThickness - t.fontMetrics().sqrtRuleThickness),
                            s = 0,
                            m = 0,
                            h = 0;
                        return "small" === i.type ? (h = 1e3 + 1e3 * l + 80, e < 1 ? o = 1 : e < 1.4 && (o = .7), s = (1 + l + .08) / o, m = (1 + l) / o, (r = sqrtSvg("sqrtMain", s, h, l, t)).style.minWidth = "0.853em", n = .833 / o) : "large" === i.type ? (h = 1080 * e$[i.size], m = (e$[i.size] + l) / o, s = (e$[i.size] + l + .08) / o, (r = sqrtSvg("sqrtSize" + i.size, s, h, l, t)).style.minWidth = "1.02em", n = 1 / o) : (s = e + l + .08, m = e + l, (r = sqrtSvg("sqrtTall", s, h = Math.floor(1e3 * e + l) + 80, l, t)).style.minWidth = "0.742em", n = 1.056), r.height = m, r.style.height = makeEm(s), {
                            span: r,
                            advanceWidth: n,
                            ruleWidth: (t.fontMetrics().sqrtRuleThickness + l) * o
                        }
                    },
                    sizedDelim: function(e, t, r, n, a) {
                        if ("<" === e || "\\lt" === e || "⟨" === e ? e = "\\langle" : (">" === e || "\\gt" === e || "⟩" === e) && (e = "\\rangle"), s.contains(eD, e) || s.contains(eO, e)) return makeLargeDelim(e, t, !1, r, n, a);
                        if (s.contains(eL, e)) return makeStackedDelim(e, e$[t], !1, r, n, a);
                    ...
                    leftRightDelim: function(e, t, r, n, a, i) {
                        var o = n.fontMetrics().axisHeight * n.sizeMultiplier,
                            ...
                            s = Math.max(t - o, r + o);
                        return makeCustomSizedDelim(e, Math.max(s / 500 * 901, 2 * s - l), !0, n, a, i)
                    }
                },
                eW = {
                    "\\bigl": {
                ...
                eX = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "<", ">", "\\langle", "⟨", "\\rangle", "⟩", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."];

            function checkDelimiter(e, t) {
                var r = checkSymbolNodeType(e);
                if (r && s.contains(eX, r.text)) return r;
                if (r) throw new ParseError("Invalid delimiter '" + r.text + "' after '" + t.funcName + "'", e);
                throw new ParseError("Invalid delimiter type '" + e.type + "'", e)
            }
            ...
            defineFunction({
                ...
                handler: (e, t) => {
                    ...
                    return {
                        type: "delimsizing",
                        mode: e.parser.mode,
                        size: eW[e.funcName].size,
                        mclass: eW[e.funcName].mclass,
                        delim: r.text
                    }
                },
                htmlBuilder: (e, t) => "." === e.delim ? eu.makeSpan([e.mclass]) : eY.sizedDelim(e.delim, e.size, t, e.mode, [e.mclass]),
                mathmlBuilder: e => {
                    var t = [];
                    "." !== e.delim && t.push(makeText(e.delim, e.mode));
                    var r = new eA.MathNode("mo", t);
                    "mopen" === e.mclass || "mclose" === e.mclass ? r.setAttribute("fence", "true") : r.setAttribute("fence", "false"), r.setAttribute("stretchy", "true");
                    var n = makeEm(eY.sizeToMaxHeight[e.size]);
                ...
                handler: (e, t) => {
                    ...
                    var i = assertNodeType(n.parseFunction(), "leftright-right");
                    return {
                        type: "leftright",
                        mode: n.mode,
                        body: a,
                ...
                htmlBuilder: (e, t) => {
                    assertParsed(e);
                    for (var r, n, a = buildExpression$1(e.body, t, !0, ["mopen", "mclose"]), i = 0, o = 0, l = !1, s = 0; s < a.length; s++) a[s].isMiddle ? l = !0 : (i = Math.max(a[s].height, i), o = Math.max(a[s].depth, o));
                    if (i *= t.sizeMultiplier, o *= t.sizeMultiplier, r = "." === e.left ? makeNullDelimiter(t, ["mopen"]) : eY.leftRightDelim(e.left, i, o, t, e.mode, ["mopen"]), a.unshift(r), l)
                        for (var m = 1; m < a.length; m++) {
                            var h = a[m].isMiddle;
                            h && (a[m] = eY.leftRightDelim(h.delim, i, o, h.options, e.mode, []))
                        }
                    if ("." === e.right) n = makeNullDelimiter(t, ["mclose"]);
                    else {
                        var d = e.rightColor ? t.withColor(e.rightColor) : t;
                        n = eY.leftRightDelim(e.right, i, o, d, e.mode, ["mclose"])
                    }
                    return a.push(n), eu.makeSpan(["minner"], a, t)
                },
                mathmlBuilder: (e, t) => {
                    assertParsed(e);
                    var r = buildExpression(e.body, t);
                    if ("." !== e.left) {
                        var n = new eA.MathNode("mo", [makeText(e.left, e.mode)]);
                        n.setAttribute("fence", "true"), r.unshift(n)
                    }
                    if ("." !== e.right) {
                        var a = new eA.MathNode("mo", [makeText(e.right, e.mode)]);
                ...
                htmlBuilder: (e, t) => {
                    var r;
                    if ("." === e.delim) r = makeNullDelimiter(t, []);
                    else {
                        r = eY.sizedDelim(e.delim, 1, t, e.mode, []);
                        var n = {
                            delim: e.delim,
                            options: t
                        };
                ...
                mathmlBuilder: (e, t) => {
                    var r = "\\vert" === e.delim || "|" === e.delim ? makeText("|", "text") : makeText(e.delim, e.mode),
                        n = new eA.MathNode("mo", [r]);
                    return n.setAttribute("fence", "true"), n.setAttribute("lspace", "0.05em"), n.setAttribute("rspace", "0.05em"), n
                }
            });
            var htmlBuilder$7 = (e, t) => {
                    var r, n, a = eu.wrapFragment(buildGroup$1(e.body, t), t),
                        i = e.label.slice(1),
                        o = t.sizeMultiplier,
                        l = 0,
                        m = s.isCharacterBox(e.body);
                    if ("sout" === i)(r = eu.makeSpan(["stretchy", "sout"])).height = t.fontMetrics().defaultRuleThickness / o, l = -.5 * t.fontMetrics().xHeight;
                    else if ("phase" === i) {
                        var h = calculateSize({
                                number: .6,
                                unit: "pt"
                        ...
                        var c = a.height + a.depth + h + d;
                        a.style.paddingLeft = makeEm(c / 2 + h);
                        var u = Math.floor(1e3 * c * o),
                            p = "M400000 " + u + " H0 L" + u / 2 + " 0 l65 45 L145 " + (u - 80) + " H400000z",
                            f = new SvgNode([new PathNode("phase", p)], {
                                width: "400em",
                                height: makeEm(u / 1e3),
                                viewBox: "0 0 400000 " + u,
                                preserveAspectRatio: "xMinYMin slice"
                            });
                        (r = eu.makeSvgSpan(["hide-tail"], [f], t)).style.height = makeEm(c), l = a.depth + h + d
                    } else {
                        /cancel/.test(i) ? m || a.classes.push("cancel-pad") : "angl" === i ? a.classes.push("anglpad") : a.classes.push("boxpad");
                        var b = 0,
                            g = 0,
                            y = 0;
                        /box/.test(i) ? (y = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness), g = b = t.fontMetrics().fboxsep + ("colorbox" === i ? 0 : y)) : "angl" === i ? (b = 4 * (y = Math.max(t.fontMetrics().defaultRuleThickness, t.minRuleThickness)), g = Math.max(0, .25 - a.depth)) : g = b = m ? .2 : 0, r = eN.encloseSpan(a, i, b, g, t), /fbox|boxed|fcolorbox/.test(i) ? (r.style.borderStyle = "solid", r.style.borderWidth = makeEm(y)) : "angl" === i && .049 !== y && (r.style.borderTopWidth = makeEm(y), r.style.borderRightWidth = makeEm(y)), l = a.depth + g, e.backgroundColor && (r.style.backgroundColor = e.backgroundColor, e.borderColor && (r.style.borderColor = e.borderColor))
                    }
                    if (e.backgroundColor) n = eu.makeVList({
                        positionType: "individualShift",
                        children: [{
                            type: "elem",
                            elem: r,
                    ...
                    return (/cancel/.test(i) && (n.height = a.height, n.depth = a.depth), /cancel/.test(i) && !m) ? eu.makeSpan(["mord", "cancel-lap"], [n], t) : eu.makeSpan(["mord"], [n], t)
                },
                mathmlBuilder$6 = (e, t) => {
                    var r = 0,
                        n = new eA.MathNode(e.label.indexOf("colorbox") > -1 ? "mpadded" : "menclose", [buildGroup(e.body, t)]);
                    switch (e.label) {
                        case "\\cancel":
            ...
            defineFunction({
                ...
                handler(e, t, r) {
                    var {
                        parser: n,
                        funcName: a
                    } = e, i = assertNodeType(t[0], "color-token").color, o = t[1];
                    return {
                        type: "enclose",
                        mode: n.mode,
                        label: a,
                ...
                handler(e, t, r) {
                    var {
                        parser: n,
                        funcName: a
                    } = e, i = assertNodeType(t[0], "color-token").color, o = assertNodeType(t[1], "color-token").color, l = t[2];
                    return {
                        type: "enclose",
                        mode: n.mode,
                        label: a,
            ...
            function parseArray(e, t, r) {
                ...
                if (e.gullet.beginGroup(), m || e.gullet.macros.set("\\cr", "\\\\\\relax"), !o) {
                    ...
                    if (null == u) o = 1;
                    else if (!(o = parseFloat(u)) || o < 0) throw new ParseError("Invalid \\arraystretch: " + u)
                }
                e.gullet.beginGroup();
                var p = [],
                    f = [p],
                ...
                function endRow() {
                    y && (e.gullet.macros.get("\\df@tag") ? (y.push(e.subparse([new Token("\\df@tag")])), e.gullet.macros.set("\\df@tag", void 0, !0)) : y.push(!!s && "1" === e.gullet.macros.get("\\@eqnsw")))
                }
                for (beginRow(), g.push(getHLines(e));;) {
                    ...
                    if ("&" === S) {
                        ...
                        endRow(), 1 === p.length && "styling" === v.type && 0 === v.body[0].body.length && (f.length > 1 || !h) && f.pop(), g.length < f.length + 1 && g.push([]);
                        break
                    } else if ("\\\\" === S) {
                        e.consume();
                        var x = void 0;
                        " " !== e.gullet.future().text && (x = e.parseSizeGroup(!0)), b.push(x ? x.value : null), endRow(), g.push(getHLines(e)), p = [], f.push(p), beginRow()
            ...
            var htmlBuilder$6 = function(e, t) {
                    var r, n, a, i, o = e.body.length,
                        ...
                        p = 5 * u;
                    e.colSeparationType && "small" === e.colSeparationType && (p = .2778 * (t.havingStyle(g.SCRIPT).sizeMultiplier / t.sizeMultiplier));
                    var f = "CD" === e.colSeparationType ? calculateSize({
                            number: 3,
                            unit: "ex"
                        }, t) : 12 * u,
                        b = 3 * u,
                    ...
                    function setHLinePos(e) {
                        for (var t = 0; t < e.length; ++t) t > 0 && (x += .25), d.push({
                            pos: x,
                            isDashed: e[t]
                        })
                    }
                    for (setHLinePos(l[0]), r = 0; r < e.body.length; ++r) {
                        var w = e.body[r],
                            k = v,
                            M = S;
                        m < w.length && (m = w.length);
                        var z = Array(w.length);
                        for (n = 0; n < w.length; ++n) {
                            var T = buildGroup$1(w[n], t);
                            M < T.depth && (M = T.depth), k < T.height && (k = T.height), z[n] = T
                        }
                        var A = e.rowGaps[r],
                            E = 0;
                        A && (E = calculateSize(A, t)) > 0 && (M < (E += S) && (M = E), E = 0), e.addJot && (M += b), z.height = k, z.depth = M, x += k, z.pos = x, x += M + E, h[r] = z, setHLinePos(l[r + 1])
                    }
                    var B = x / 2 + t.fontMetrics().axisHeight,
                        N = e.cols || [],
                        C = [],
                        q = [];
                    if (e.tags && e.tags.some(e => e))
                        for (r = 0; r < o; ++r) {
                            var P = h[r],
                                ...
                                H = e.tags[r],
                                R = void 0;
                            (R = !0 === H ? eu.makeSpan(["eqn-num"], [], t) : !1 === H ? eu.makeSpan([], [], t) : eu.makeSpan([], buildExpression$1(H, t, !0), t)).depth = P.depth, R.height = P.height, q.push({
                                type: "elem",
                                elem: R,
                                shift: F
                            })
                        }
                    for (n = 0, i = 0; n < m || i < N.length; ++n, ++i) {
                        for (var I = N[i] || {}, D = !0;
                            "separator" === I.type;) {
                            if (D || ((a = eu.makeSpan(["arraycolsep"], [])).style.width = makeEm(t.fontMetrics().doubleRuleSep), C.push(a)), "|" === I.separator || ":" === I.separator) {
                                var L = "|" === I.separator ? "solid" : "dashed",
                                    O = eu.makeSpan(["vertical-separator"], [], t);
                                O.style.height = makeEm(x), O.style.borderRightWidth = makeEm(c), O.style.borderRightStyle = L, O.style.margin = "0 " + makeEm(-c / 2);
                                var $ = x - B;
                                $ && (O.style.verticalAlign = makeEm(-$)), C.push(O)
                            } else throw new ParseError("Invalid separator type: " + I.separator);
                            I = N[++i] || {}, D = !1
                        }
                        if (!(n >= m)) {
                            var G = void 0;
                            (n > 0 || e.hskipBeforeAndAfter) && 0 !== (G = s.deflt(I.pregap, p)) && ((a = eu.makeSpan(["arraycolsep"], [])).style.width = makeEm(G), C.push(a));
                            var V = [];
                            for (r = 0; r < o; ++r) {
                                var U = h[r],
                                    Y = U[n];
                                if (Y) {
                                    var W = U.pos - B;
                                    Y.depth = U.depth, Y.height = U.height, V.push({
                                        type: "elem",
                                        elem: Y,
                                        shift: W
                                    })
                            ...
                            V = eu.makeVList({
                                positionType: "individualShift",
                                children: V
                            }, t), V = eu.makeSpan(["col-align-" + (I.align || "c")], [V]), C.push(V), (n < m - 1 || e.hskipBeforeAndAfter) && 0 !== (G = s.deflt(I.postgap, p)) && ((a = eu.makeSpan(["arraycolsep"], [])).style.width = makeEm(G), C.push(a))
                        }
                    }
                    if (h = eu.makeSpan(["mtable"], C), d.length > 0) {
                        for (var X = eu.makeLineSpan("hline", t, c), _ = eu.makeLineSpan("hdashline", t, c), j = [{
                                type: "elem",
                                elem: h,
                                shift: 0
                            }]; d.length > 0;) {
                    ...
                    if (0 === q.length) return eu.makeSpan(["mord"], [h], t);
                    var J = eu.makeVList({
                        positionType: "individualShift",
                        children: q
                    }, t);
                    return J = eu.makeSpan(["tag"], [J], t), eu.makeFragment([h, J])
                },
                eZ = {
                    c: "center ",
                    l: "left ",
                ...
                mathmlBuilder$5 = function(e, t) {
                    for (var r = [], n = new eA.MathNode("mtd", [], ["mtr-glue"]), a = new eA.MathNode("mtd", [], ["mml-eqn-num"]), i = 0; i < e.body.length; i++) {
                        for (var o = e.body[i], l = [], s = 0; s < o.length; s++) l.push(new eA.MathNode("mtd", [buildGroup(o[s], t)]));
                        e.tags && e.tags[i] && (l.unshift(n), l.push(n), e.leqno ? l.unshift(a) : l.push(a)), r.push(new eA.MathNode("mtr", l))
                    }
                    var m = new eA.MathNode("mtable", r),
                        h = .5 === e.arraystretch ? .1 : .16 + e.arraystretch - 1 + (e.addJot ? .09 : 0);
                    m.setAttribute("rowspacing", makeEm(h));
                    var d = "",
                        c = "";
                    if (e.cols && e.cols.length > 0) {
                        var u = e.cols,
                            ...
                            b = 0,
                            g = u.length;
                        "separator" === u[0].type && (d += "top ", b = 1), "separator" === u[u.length - 1].type && (d += "bottom ", g -= 1);
                        for (var y = b; y < g; y++) "align" === u[y].type ? (c += eZ[u[y].align], f && (p += "none "), f = !0) : "separator" === u[y].type && f && (p += "|" === u[y].separator ? "solid " : "dashed ", f = !1);
                        m.setAttribute("columnalign", c.trim()), /[sd]/.test(p) && m.setAttribute("columnlines", p.trim())
                    }
                    ...
                    var w = "",
                        k = e.hLinesBeforeRow;
                    d += (k[0].length > 0 ? "left " : "") + (k[k.length - 1].length > 0 ? "right " : "");
                    for (var M = 1; M < k.length - 1; M++) w += 0 === k[M].length ? "none " : k[M][0] ? "dashed " : "solid ";
                    return /[sd]/.test(w) && m.setAttribute("rowlines", w.trim()), "" !== d && (m = new eA.MathNode("menclose", [m])).setAttribute("notation", d.trim()), e.arraystretch && e.arraystretch < 1 && (m = new eA.MathNode("mstyle", [m])).setAttribute("scriptlevel", "1"), m
                },
                alignedHandler = function(e, t) {
                    ...
                    var r, n = [],
                        ...
                        i = "split" === e.envName,
                        o = parseArray(e.parser, {
                            cols: n,
                            addJot: !0,
                            autoTag: i ? void 0 : getAutoTag(e.envName),
                            emptySingleRow: !0,
                            colSeparationType: a,
                    ...
                    if (t[0] && "ordgroup" === t[0].type) {
                        for (var m = "", h = 0; h < t[0].body.length; h++) m += assertNodeType(t[0].body[h], "textord").text;
                        l = 2 * (r = Number(m))
                    }
                    var d = !l;
                    o.body.forEach(function(e) {
                        ...
                        if (d) l < e.length && (l = e.length);
                        else {
                            var a = e.length / 2;
                            if (r < a) throw new ParseError("Too many math in a row: expected " + r + ", but got " + a, e[0])
                        }
                    });
                    for (var c = 0; c < l; ++c) {
                        var u = "r",
                            p = 0;
                        c % 2 == 1 ? u = "l" : c > 0 && d && (p = 1), n[c] = {
                            type: "align",
                            align: u,
                            pregap: p,
                            postgap: 0
            ...
            defineEnvironment({
                ...
                handler(e) {
                    ...
                    if ("*" === e.envName.charAt(e.envName.length - 1)) {
                        ...
                        if (a.consumeSpaces(), "[" === a.fetch().text) {
                            if (a.consume(), a.consumeSpaces(), r = a.fetch().text, -1 === "lcr".indexOf(r)) throw new ParseError("Expected l or c or r", a.nextToken);
                    ...
                    var i = parseArray(e.parser, n, dCellStyle(e.envName)),
                        o = Math.max(0, ...i.body.map(e => e.length));
                    return i.cols = Array(o).fill({
                        type: "align",
                        align: r
                    }), t ? {
                        type: "leftright",
                ...
                handler(e) {
                    s.contains(["gather", "gather*"], e.envName) && validateAmsEnvironmentContext(e);
                    var t = {
                        cols: [{
                            type: "align",
                            align: "c"
                ...
                handler: e => (validateAmsEnvironmentContext(e), function(e) {
                    var t = [];
                    ...
                    for (var n = [], a = [n], i = 0; i < t.length; i++) {
                        for (var o = t[i], l = newCell(), s = 0; s < o.length; s++)
                            if (isStartOfArrow(o[s])) {
                                n.push(l);
                                var m = assertSymbolNodeType(o[s += 1]).text,
                                    h = [, , ];
                                if (h[0] = {
                                        type: "ordgroup",
                                        mode: "math",
                                    ...
                                    for (var d = 0; d < 2; d++) {
                                        for (var c = !0, u = s + 1; u < o.length; u++) {
                                            if (isLabelEnd(o[u], m)) {
                                                c = !1, s = u;
                                                break
                                            }
                                            if (isStartOfArrow(o[u])) throw new ParseError("Missing a " + m + " character to complete a CD arrow.", o[u]);
                                            h[d].body.push(o[u])
                                        }
                                        if (c) throw new ParseError("Missing a " + m + " character to complete a CD arrow.", o[s])
                                    } else throw new ParseError('Expected one of "<>AV=|." after @', o[s]);
                                var p = {
                                    type: "styling",
                                    body: [function(e, t, r) {
                                        var n = eP[e];
                                        switch (n) {
                                            ...
                                            case "\\uparrow":
                                            case "\\downarrow":
                                                var a = r.callFunction("\\\\cdleft", [t[0]], []),
                ...
                handler(e, t) {
                    ...
                    if ("ordgroup" !== a.type) throw new ParseError("Invalid environment name", a);
                    for (var i = "", o = 0; o < a.body.length; ++o) i += assertNodeType(a.body[o], "textord").text;
                    if ("\\begin" === n) {
                        if (!e_.hasOwnProperty(i)) throw new ParseError("No such environment: " + i, a);
                        var l = e_[i],
                            {
                                args: s,
                                optArgs: m
                            } = r.parseArguments("\\begin{" + i + "}", l),
                            h = {
                                mode: r.mode,
                                envName: i,
                                parser: r
                        ...
                        r.expect("\\end", !1);
                        var c = r.nextToken,
                            u = assertNodeType(r.parseFunction(), "environment");
                        if (u.name !== i) throw new ParseError("Mismatch: \\begin{" + i + "} matched by \\end{" + u.name + "}", c);
                        return d
                    }
                    return {
                        type: "environment",
            ...
            var htmlBuilder$5 = (e, t) => {
                    var r = e.font,
                        n = t.withFont(r);
                    return buildGroup$1(e.body, n)
                },
                mathmlBuilder$4 = (e, t) => {
                    var r = e.font,
                        n = t.withFont(r);
                    return buildGroup(e.body, n)
                },
                eK = {
                    "\\Bbb": "\\mathbb",
                    "\\bold": "\\mathbf",
            ...
            defineFunction({
                ...
                handler: (e, t) => {
                    var {
                        parser: r,
                        funcName: n
                    } = e, a = normalizeArgument(t[0]), i = n;
                    return i in eK && (i = eK[i]), {
                        type: "font",
                        mode: r.mode,
                        font: i.slice(1),
                        body: a
            ...
            var adjustStyle = (e, t) => {
                    var r = t;
                    return "display" === e ? r = r.id >= g.SCRIPT.id ? r.text() : g.DISPLAY : "text" === e && r.size === g.DISPLAY.size ? r = g.TEXT : "script" === e ? r = g.SCRIPT : "scriptscript" === e && (r = g.SCRIPTSCRIPT), r
                },
                htmlBuilder$4 = (e, t) => {
                    var r, n, a, i, o, l, s, m, h, d, c, u = adjustStyle(e.size, t.style),
                        p = u.fracNum(),
                        f = u.fracDen();
                    r = t.havingStyle(p);
                    var b = buildGroup$1(e.numer, r, t);
                    if (e.continued) {
                        var y = 8.5 / t.fontMetrics().ptPerEm,
                            v = 3.5 / t.fontMetrics().ptPerEm;
                        b.height = b.height < y ? y : b.height, b.depth = b.depth < v ? v : b.depth
                    }
                    r = t.havingStyle(f);
                    var S = buildGroup$1(e.denom, r, t);
                    if (e.hasBarLine ? (e.barSize ? (a = calculateSize(e.barSize, t), n = eu.makeLineSpan("frac-line", t, a)) : n = eu.makeLineSpan("frac-line", t), a = n.height, i = n.height) : (n = null, a = 0, i = t.fontMetrics().defaultRuleThickness), u.size === g.DISPLAY.size || "display" === e.size ? (o = t.fontMetrics().num1, l = a > 0 ? 3 * i : 7 * i, s = t.fontMetrics().denom1) : (a > 0 ? (o = t.fontMetrics().num2, l = i) : (o = t.fontMetrics().num3, l = 3 * i), s = t.fontMetrics().denom2), n) {
                        var x = t.fontMetrics().axisHeight;
                        o - b.depth - (x + .5 * a) < l && (o += l - (o - b.depth - (x + .5 * a))), x - .5 * a - (S.height - s) < l && (s += l - (x - .5 * a - (S.height - s)));
                        var w = -(x - .5 * a);
                        m = eu.makeVList({
                            positionType: "individualShift",
                            children: [{
                        ...
                        var k = o - b.depth - (S.height - s);
                        k < l && (o += .5 * (l - k), s += .5 * (l - k)), m = eu.makeVList({
                            positionType: "individualShift",
                            children: [{
                                type: "elem",
                                elem: S,
                ...
                mathmlBuilder$3 = (e, t) => {
                    ...
                    if (a.size !== t.style.size) {
                        r = new eA.MathNode("mstyle", [r]);
                        var i = a.size === g.DISPLAY.size ? "true" : "false";
                        r.setAttribute("displaystyle", i), r.setAttribute("scriptlevel", "0")
                    }
                    if (null != e.leftDelim || null != e.rightDelim) {
                        var o = [];
                        if (null != e.leftDelim) {
                            var l = new eA.MathNode("mo", [new eA.TextNode(e.leftDelim.replace("\\", ""))]);
                            l.setAttribute("fence", "true"), o.push(l)
                        }
                        if (o.push(r), null != e.rightDelim) {
                            var s = new eA.MathNode("mo", [new eA.TextNode(e.rightDelim.replace("\\", ""))]);
            ...
            var eJ = ["display", "text", "script", "scriptscript"],
            ...
            defineFunction({
                ...
                handler(e, t) {
                    var r, {
                        ...
                        a = t[4],
                        i = t[5],
                        o = normalizeArgument(t[0]),
                        l = "atom" === o.type && "open" === o.family ? delimFromValue(o.text) : null,
                        s = normalizeArgument(t[1]),
                        m = "atom" === s.type && "close" === s.family ? delimFromValue(s.text) : null,
                        h = assertNodeType(t[2], "size"),
                        d = null;
                    r = !!h.isBlank || (d = h.value).number > 0;
                    var c = "auto",
                        u = t[3];
                    return "ordgroup" === u.type ? u.body.length > 0 && (c = eJ[Number(assertNodeType(u.body[0], "textord").text)]) : c = eJ[Number((u = assertNodeType(u, "textord")).text)], {
                        type: "genfrac",
                        mode: n.mode,
                        numer: a,
                        denom: i,
                ...
                handler: (e, t) => {
                    var {
                        parser: r,
                        funcName: n
                    } = e, a = t[0], i = assert(assertNodeType(t[1], "infix").size), o = t[2], l = i.number > 0;
                    return {
                        type: "genfrac",
                        mode: r.mode,
                        numer: a,
            ...
            var htmlBuilder$3 = (e, t) => {
                var r, n, a, i = t.style;
                "supsub" === e.type ? (r = e.sup ? buildGroup$1(e.sup, t.havingStyle(i.sup()), t) : buildGroup$1(e.sub, t.havingStyle(i.sub()), t), n = assertNodeType(e.base, "horizBrace")) : n = assertNodeType(e, "horizBrace");
                var o = buildGroup$1(n.base, t.havingBaseStyle(g.DISPLAY)),
                    l = eN.svgSpan(n, t);
                if (n.isOver ? (a = eu.makeVList({
                        positionType: "firstBaseline",
                        children: [{
                            type: "elem",
                            elem: o
                    ...
                    }, t)).children[0].children[0].children[1].classes.push("svg-align") : (a = eu.makeVList({
                        positionType: "bottom",
                    ...
                    var s = eu.makeSpan(["mord", n.isOver ? "mover" : "munder"], [a], t);
                    a = n.isOver ? eu.makeVList({
                        positionType: "firstBaseline",
                        children: [{
                            type: "elem",
                            elem: s
                ...
                return eu.makeSpan(["mord", n.isOver ? "mover" : "munder"], [a], t)
            };
            defineFunction({
                type: "horizBrace",
                ...
                mathmlBuilder: (e, t) => {
                    var r = eN.mathMLnode(e.label);
                    return new eA.MathNode(e.isOver ? "mover" : "munder", [buildGroup(e.base, t), r])
                }
            }), defineFunction({
                type: "href",
                names: ["\\href"],
                ...
                handler: (e, t) => {
                    var {
                        parser: r
                    } = e, n = t[1], a = assertNodeType(t[0], "url").url;
                ...
                htmlBuilder: (e, t) => {
                    ...
                    return eu.makeAnchor(e.href, [], r, t)
                },
                mathmlBuilder: (e, t) => {
                ...
                handler: (e, t) => {
                    var {
                        parser: r
                    } = e, n = assertNodeType(t[0], "url").url;
                ...
                mathmlBuilder: (e, t) => new eA.MathNode("mrow", buildExpression(e.body, t))
            }), defineFunction({
                type: "html",
                ...
                handler: (e, t) => {
                    var r, {
                        ...
                        o = assertNodeType(t[0], "raw").string,
                        l = t[1];
                    ...
                    switch (a) {
                        ...
                        case "\\htmlStyle":
                            ...
                            break;
                        case "\\htmlData":
                            for (var m = o.split(","), h = 0; h < m.length; h++) {
                                var d = m[h].split("=");
                                if (2 !== d.length) throw new ParseError("Error parsing key-value for \\htmlData");
            ...
            defineFunction({
                ...
                handler: (e, t, r) => {
                    ...
                    if (r[0])
                        for (var s = assertNodeType(r[0], "raw").string.split(","), m = 0; m < s.length; m++) {
                            var h = s[m].split("=");
                            if (2 === h.length) {
                                var d = h[1].trim();
                                switch (h[0].trim()) {
                                    ...
                                    case "totalheight":
                                        ...
                                        break;
                                    default:
                                        throw new ParseError("Invalid key: '" + h[0] + "' in \\includegraphics.")
                                }
                            }
                        }
                ...
                htmlBuilder: (e, t) => {
                    var r = calculateSize(e.height, t),
                        n = 0;
                    e.totalheight.number > 0 && (n = calculateSize(e.totalheight, t) - r);
                    var a = 0;
                    e.width.number > 0 && (a = calculateSize(e.width, t));
                    var i = {
                        height: makeEm(r + n)
                    };
                    a > 0 && (i.width = makeEm(a)), n > 0 && (i.verticalAlign = makeEm(-n));
                    var o = new Img(e.src, e.alt, i);
                    return o.height = r, o.depth = n, o
                },
                mathmlBuilder: (e, t) => {
                    var r = new eA.MathNode("mglyph", []);
                    r.setAttribute("alt", e.alt);
                    var n = calculateSize(e.height, t),
                        a = 0;
                    if (e.totalheight.number > 0 && (a = calculateSize(e.totalheight, t) - n, r.setAttribute("valign", makeEm(-a))), r.setAttribute("height", makeEm(n + a)), e.width.number > 0) {
                        var i = calculateSize(e.width, t);
                        r.setAttribute("width", makeEm(i))
                    }
                ...
                htmlBuilder: (e, t) => eu.makeGlue(e.dimension, t),
                mathmlBuilder(e, t) {
                    var r = calculateSize(e.dimension, t);
                    return new eA.SpaceNode(r)
                }
            }), defineFunction({
                type: "lap",
                ...
                htmlBuilder: (e, t) => {
                    "clap" === e.alignment ? (r = eu.makeSpan([], [buildGroup$1(e.body, t)]), r = eu.makeSpan(["inner"], [r], t)) : r = eu.makeSpan(["inner"], [buildGroup$1(e.body, t)]);
                    var r, n = eu.makeSpan(["fix"], []),
                        a = eu.makeSpan([e.alignment], [r, n], t),
                        i = eu.makeSpan(["strut"]);
                    return i.style.height = makeEm(a.height + a.depth), a.depth && (i.style.verticalAlign = makeEm(-a.depth)), a.children.unshift(i), a = eu.makeSpan(["thinbox"], [a], t), eu.makeSpan(["mord", "vbox"], [a], t)
                },
                mathmlBuilder: (e, t) => {
                    var r = new eA.MathNode("mpadded", [buildGroup(e.body, t)]);
                    if ("rlap" !== e.alignment) {
            ...
            defineFunction({
                ...
                htmlBuilder: (e, t) => {
                    var r = buildExpression$1(chooseMathStyle(e, t), t, !1);
                    return eu.makeFragment(r)
                },
                mathmlBuilder: (e, t) => buildExpressionRow(chooseMathStyle(e, t), t)
            });
            var assembleSupSub = (e, t, r, n, a, i, o) => {
                    e = eu.makeSpan([], [e]);
                    var l, m, h, d = r && s.isCharacterBox(r);
                    if (t) {
                        var c = buildGroup$1(t, n.havingStyle(a.sup()), n);
                        m = {
                            elem: c,
                    ...
                    if (r) {
                        var u = buildGroup$1(r, n.havingStyle(a.sub()), n);
                        l = {
                            elem: u,
                    ...
                    if (m && l) {
                        var p = n.fontMetrics().bigOpSpacing5 + l.elem.height + l.elem.depth + l.kern + e.depth + o;
                        h = eu.makeVList({
                            positionType: "bottom",
                            positionData: p,
                            children: [{
                    ...
                    var g = [h];
                    if (l && 0 !== i && !d) {
                        var y = eu.makeSpan(["mspace"], [], n);
                        y.style.marginRight = makeEm(i), g.unshift(y)
                    }
                    return eu.makeSpan(["mop", "op-limits"], g, n)
                },
                eQ = ["\\smallint"],
                htmlBuilder$2 = (e, t) => {
                    var r, n, a, i, o = !1;
                    "supsub" === e.type ? (r = e.sup, n = e.sub, a = assertNodeType(e.base, "op"), o = !0) : a = assertNodeType(e, "op");
                    var l = t.style,
                        m = !1;
                    if (l.size === g.DISPLAY.size && a.symbol && !s.contains(eQ, a.name) && (m = !0), a.symbol) {
                        var h = m ? "Size2-Regular" : "Size1-Regular",
                            d = "";
                        if (("\\oiint" === a.name || "\\oiiint" === a.name) && (d = a.name.slice(1), a.name = "oiint" === d ? "\\iint" : "\\iiint"), i = eu.makeSymbol(a.name, h, "math", t, ["mop", "op-symbol", m ? "large-op" : "small-op"]), d.length > 0) {
                            var c = i.italic,
                                u = eu.staticSvg(d + "Size" + (m ? "2" : "1"), t);
                            i = eu.makeVList({
                                positionType: "individualShift",
                                children: [{
                                    type: "elem",
                            ...
                            }, t), a.name = "\\" + d, i.classes.unshift("mop"), i.italic = c
                        }
                    } else if (a.body) {
                        var p = buildExpression$1(a.body, t, !0);
                        1 === p.length && p[0] instanceof SymbolNode ? (i = p[0]).classes[0] = "mop" : i = eu.makeSpan(["mop"], p, t)
                    } else {
                        for (var f = [], b = 1; b < a.name.length; b++) f.push(eu.mathsym(a.name[b], a.mode, t));
                        i = eu.makeSpan(["mop"], f, t)
                    }
                    var y = 0,
                        v = 0;
                    return ((i instanceof SymbolNode || "\\oiint" === a.name || "\\oiiint" === a.name) && !a.suppressBaseShift && (y = (i.height - i.depth) / 2 - t.fontMetrics().axisHeight, v = i.italic), o) ? assembleSupSub(i, r, n, t, l, v, y) : (y && (i.style.position = "relative", i.style.top = makeEm(y)), i)
                },
                mathmlBuilder$1 = (e, t) => {
                    var r;
                    if (e.symbol) r = new MathNode("mo", [makeText(e.name, e.mode)]), s.contains(eQ, e.name) && r.setAttribute("largeop", "false");
                    else if (e.body) r = new MathNode("mo", buildExpression(e.body, t));
                    else {
                        r = new MathNode("mi", [new TextNode(e.name.slice(1))]);
                        var n = new MathNode("mo", [makeText("⁡", "text")]);
                        r = e.parentIsSupSub ? new MathNode("mrow", [r, n]) : newDocumentFragment([r, n])
                    }
                    return r
                },
                e0 = {
            ...
            var htmlBuilder$1 = (e, t) => {
                var r, n, a, i, o = !1;
                if ("supsub" === e.type ? (r = e.sup, n = e.sub, a = assertNodeType(e.base, "operatorname"), o = !0) : a = assertNodeType(e, "operatorname"), a.body.length > 0) {
                    for (var l = buildExpression$1(a.body.map(e => {
                            var t = e.text;
                    ...
                    i = eu.makeSpan(["mop"], l, t)
                } else i = eu.makeSpan(["mop"], [], t);
                return o ? assembleSupSub(i, r, n, t, t.style, 0, 0) : i
            };

            function sizingGroup(e, t, r) {
                for (var n = buildExpression$1(e, t, !1), a = t.sizeMultiplier / r.sizeMultiplier, i = 0; i < n.length; i++) {
            ...
            defineFunction({
                ...
                mathmlBuilder: (e, t) => {
                    for (var r = buildExpression(e.body, t.withFont("mathrm")), n = !0, a = 0; a < r.length; a++) {
                        var i = r[a];
                        if (i instanceof eA.SpaceNode);
                        else if (i instanceof eA.MathNode) switch (i.type) {
                            case "mi":
                            case "mn":
                            case "ms":
                            case "mspace":
                            ...
                            case "mo":
                                var o = i.children[0];
                                1 === i.children.length && o instanceof eA.TextNode ? o.text = o.text.replace(/\u2212/, "-").replace(/\u2217/, "*") : n = !1;
                                break;
                            default:
                                n = !1
                        } else n = !1
                    ...
                    var s = new eA.MathNode("mi", r);
                    s.setAttribute("mathvariant", "normal");
                    var m = new eA.MathNode("mo", [makeText("⁡", "text")]);
                    return e.parentIsSupSub ? new eA.MathNode("mrow", [s, m]) : eA.newDocumentFragment([s, m])
                }
            }), ej["\\operatorname"] = "\\@ifstar\\operatornamewithlimits\\operatorname@", defineFunctionBuilders({
                type: "ordgroup",
                htmlBuilder: (e, t) => e.semisimple ? eu.makeFragment(buildExpression$1(e.body, t, !1)) : eu.makeSpan(["mord"], buildExpression$1(e.body, t, !0), t),
                mathmlBuilder: (e, t) => buildExpressionRow(e.body, t, !0)
            }), defineFunction({
                type: "overline",
                names: ["\\overline"],
                props: {
                ...
                htmlBuilder(e, t) {
                    var r = buildGroup$1(e.body, t.havingCrampedStyle()),
                        n = eu.makeLineSpan("overline-line", t),
                    ...
                    return eu.makeSpan(["mord", "overline"], [i], t)
                },
                mathmlBuilder(e, t) {
                    var r = new eA.MathNode("mo", [new eA.TextNode("‾")]);
                    r.setAttribute("stretchy", "true");
                    var n = new eA.MathNode("mover", [buildGroup(e.body, t), r]);
                    return n.setAttribute("accent", "true"), n
                }
            }), defineFunction({
                type: "phantom",
                ...
                mathmlBuilder: (e, t) => {
                    var r = buildExpression(e.body, t);
                    return new eA.MathNode("mphantom", r)
                }
            }), defineFunction({
                type: "hphantom",
                names: ["\\hphantom"],
                ...
                htmlBuilder: (e, t) => {
                    var r = eu.makeSpan([], [buildGroup$1(e.body, t.withPhantom())]);
                    if (r.height = 0, r.depth = 0, r.children)
                        for (var n = 0; n < r.children.length; n++) r.children[n].height = 0, r.children[n].depth = 0;
                    return r = eu.makeVList({
                        positionType: "firstBaseline",
                        children: [{
                            type: "elem",
                            elem: r
                        }]
                    }, t), eu.makeSpan(["mord"], [r], t)
                },
                mathmlBuilder: (e, t) => {
                    var r = buildExpression(ordargument(e.body), t),
                        n = new eA.MathNode("mphantom", r),
                        a = new eA.MathNode("mpadded", [n]);
                ...
                htmlBuilder: (e, t) => {
                    var r = eu.makeSpan(["inner"], [buildGroup$1(e.body, t.withPhantom())]),
                        n = eu.makeSpan(["fix"], []);
                    return eu.makeSpan(["mord", "rlap"], [r, n], t)
                },
                mathmlBuilder: (e, t) => {
                    var r = buildExpression(ordargument(e.body), t),
                        n = new eA.MathNode("mphantom", r),
                ...
                handler(e, t) {
                    var {
                        parser: r
                    } = e, n = assertNodeType(t[0], "size").value, a = t[1];
                    return {
                        type: "raisebox",
                        mode: r.mode,
                        dy: n,
                ...
                htmlBuilder(e, t) {
                    var r = buildGroup$1(e.body, t),
                        n = calculateSize(e.dy, t);
                    return eu.makeVList({
                        positionType: "shift",
                        positionData: -n,
                        children: [{
                ...
                handler(e, t, r) {
                    var {
                        parser: n
                    } = e, a = r[0], i = assertNodeType(t[0], "size"), o = assertNodeType(t[1], "size");
                    return {
                        type: "rule",
                        mode: n.mode,
                ...
                htmlBuilder(e, t) {
                    var r = eu.makeSpan(["mord", "rule"], [], t),
                        n = calculateSize(e.width, t),
                        a = calculateSize(e.height, t),
                        i = e.shift ? calculateSize(e.shift, t) : 0;
                    return r.style.borderRightWidth = makeEm(n), r.style.borderTopWidth = makeEm(a), r.style.bottom = makeEm(i), r.width = n, r.height = a + i, r.depth = -i, r.maxFontSize = 1.125 * a * t.sizeMultiplier, r
                },
                mathmlBuilder(e, t) {
                    var r = calculateSize(e.width, t),
                        n = calculateSize(e.height, t),
                        a = e.shift ? calculateSize(e.shift, t) : 0,
                        i = t.color && t.getColor() || "black",
                        o = new eA.MathNode("mspace");
                    o.setAttribute("mathbackground", i), o.setAttribute("width", makeEm(r)), o.setAttribute("height", makeEm(n));
                    var l = new eA.MathNode("mpadded", [o]);
                    return a >= 0 ? l.setAttribute("height", makeEm(a)) : (l.setAttribute("height", makeEm(a)), l.setAttribute("depth", makeEm(-a))), l.setAttribute("voffset", makeEm(a)), l
                }
            });
            ...
            defineFunction({
                ...
                mathmlBuilder: (e, t) => {
                    var r = t.havingSize(e.size),
                        n = buildExpression(e.body, r),
                        a = new eA.MathNode("mstyle", n);
                    return a.setAttribute("mathsize", makeEm(r.sizeMultiplier)), a
                }
            }), defineFunction({
                type: "smash",
                names: ["\\smash"],
                ...
                handler: (e, t, r) => {
                    var {
                        parser: n
                    } = e, a = !1, i = !1, o = r[0] && assertNodeType(r[0], "ordgroup");
                    if (o)
                        for (var l = "", s = 0; s < o.body.length; ++s)
                            if ("t" === (l = o.body[s].text)) a = !0;
                            else if ("b" === l) i = !0;
                    else {
                        a = !1, i = !1;
                        break
                ...
                htmlBuilder: (e, t) => {
                    var r = eu.makeSpan([], [buildGroup$1(e.body, t)]);
                ...
                htmlBuilder(e, t) {
                    var r = buildGroup$1(e.body, t.havingCrampedStyle());
                    0 === r.height && (r.height = t.fontMetrics().xHeight), r = eu.wrapFragment(r, t);
                    var n = t.fontMetrics().defaultRuleThickness,
                        a = n;
                    t.style.id < g.TEXT.id && (a = t.fontMetrics().xHeight);
                    var i = n + a / 4,
                    ...
                    var d = l.height - r.height - i - s;
                    r.style.paddingLeft = makeEm(m);
                    var c = eu.makeVList({
                        positionType: "firstBaseline",
                        children: [{
                            type: "elem",
                    ...
                    if (!e.index) return eu.makeSpan(["mord", "sqrt"], [c], t);
                    var u = t.havingStyle(g.SCRIPTSCRIPT),
                        p = buildGroup$1(e.index, u, t),
                        f = .6 * (c.height - c.depth),
                        b = eu.makeVList({
                            positionType: "shift",
                            positionData: -f,
                            children: [{
                        ...
                        y = eu.makeSpan(["root"], [b]);
                    return eu.makeSpan(["mord", "sqrt"], [y, c], t)
                },
                mathmlBuilder(e, t) {
                    var {
                        body: r,
                    ...
                    return n ? new eA.MathNode("mroot", [buildGroup(r, t), buildGroup(n, t)]) : new eA.MathNode("msqrt", [buildGroup(r, t)])
                }
            });
            var e5 = {
                display: g.DISPLAY,
            ...
            defineFunction({
                ...
                handler(e, t) {
                    var {
                        ...
                        funcName: n,
                        parser: a
                    } = e, i = a.parseExpression(!0, r), o = n.slice(1, n.length - 5);
                    return {
                        type: "styling",
                        mode: a.mode,
                        style: o,
                ...
                mathmlBuilder(e, t) {
                    var r = e5[e.style],
                        n = t.havingStyle(r),
                        a = buildExpression(e.body, n),
                        i = new eA.MathNode("mstyle", a),
                        o = {
                            display: ["0", "true"],
                            text: ["0", "false"],
                            script: ["1", "false"],
            ...
            var htmlBuilderDelegate = function(e, t) {
                var r = e.base;
                return r ? "op" === r.type ? r.limits && (t.style.size === g.DISPLAY.size || r.alwaysHandleSupSub) ? htmlBuilder$2 : null : "operatorname" === r.type ? r.alwaysHandleSupSub && (t.style.size === g.DISPLAY.size || r.limits) ? htmlBuilder$1 : null : "accent" === r.type ? s.isCharacterBox(r.base) ? htmlBuilder$a : null : "horizBrace" === r.type ? !e.sub === r.isOver ? htmlBuilder$3 : null : null : null
            };
            defineFunctionBuilders({
                type: "supsub",
                htmlBuilder(e, t) {
                    var r, n, a, i, o = htmlBuilderDelegate(e, t);
                    if (o) return o(e, t);
                    var {
                        base: l,
                        sup: m,
                        sub: h
                    } = e, d = buildGroup$1(l, t), c = t.fontMetrics(), u = 0, p = 0, f = l && s.isCharacterBox(l);
                    if (m) {
                        var b = t.havingStyle(t.style.sup());
                        r = buildGroup$1(m, b, t), f || (u = d.height - b.fontMetrics().supDrop * b.sizeMultiplier / t.sizeMultiplier)
                    }
                    if (h) {
                        var y = t.havingStyle(t.style.sub());
                        n = buildGroup$1(h, y, t), f || (p = d.depth + y.fontMetrics().subDrop * y.sizeMultiplier / t.sizeMultiplier)
                    }
                    a = t.style === g.DISPLAY ? c.sup1 : t.style.cramped ? c.sup3 : c.sup2;
                    var v = t.sizeMultiplier,
                        S = makeEm(.5 / c.ptPerEm / v),
                        x = null;
                    if (n) {
                        var w = e.base && "op" === e.base.type && e.base.name && ("\\oiint" === e.base.name || "\\oiiint" === e.base.name);
                        (d instanceof SymbolNode || w) && (x = makeEm(-d.italic))
                    }
                    if (r && n) {
                        u = Math.max(u, a, r.depth + .25 * c.xHeight), p = Math.max(p, c.sub2);
                        var k = 4 * c.defaultRuleThickness;
                        if (u - r.depth - (n.height - p) < k) {
                            p = k - (u - r.depth) + n.height;
                            var M = .8 * c.xHeight - (u - r.depth);
                            M > 0 && (u += M, p -= M)
                        }
                        var z = [{
                            type: "elem",
                        ...
                        p = Math.max(p, c.sub1, n.height - .8 * c.xHeight);
                        var T = [{
                            type: "elem",
                            elem: n,
                            marginLeft: x,
                    ...
                    } else if (r) u = Math.max(u, a, r.depth + .25 * c.xHeight), i = eu.makeVList({
                        positionType: "shift",
                        positionData: -u,
                        children: [{
                            type: "elem",
                    ...
                    var A = getTypeOfDomTree(d, "right") || "mord";
                    return eu.makeSpan([A], [d, eu.makeSpan(["msupsub"], [i])], t)
                },
                mathmlBuilder(e, t) {
                    var r, n, a = !1;
                    ...
                    var i = [buildGroup(e.base, t)];
                    if (e.sub && i.push(buildGroup(e.sub, t)), e.sup && i.push(buildGroup(e.sup, t)), a) n = r ? "mover" : "munder";
                    else if (e.sub) {
                        if (e.sup) {
                            var o = e.base;
                            n = o && "op" === o.type && o.limits && t.style === g.DISPLAY ? "munderover" : o && "operatorname" === o.type && o.alwaysHandleSupSub && (t.style === g.DISPLAY || o.limits) ? "munderover" : "msubsup"
                        } else {
                            var l = e.base;
                            n = l && "op" === l.type && l.limits && (t.style === g.DISPLAY || l.alwaysHandleSupSub) ? "munder" : l && "operatorname" === l.type && l.alwaysHandleSupSub && (l.limits || t.style === g.DISPLAY) ? "munder" : "msub"
                        }
                    } else {
                        var s = e.base;
                        n = s && "op" === s.type && s.limits && (t.style === g.DISPLAY || s.alwaysHandleSupSub) ? "mover" : s && "operatorname" === s.type && s.alwaysHandleSupSub && (s.limits || t.style === g.DISPLAY) ? "mover" : "msup"
                    }
                    return new eA.MathNode(n, i)
                }
            }), defineFunctionBuilders({
                type: "atom",
                htmlBuilder: (e, t) => eu.mathsym(e.text, e.mode, t, ["m" + e.family]),
                mathmlBuilder(e, t) {
                    var r = new eA.MathNode("mo", [makeText(e.text, e.mode)]);
                    if ("bin" === e.family) {
                        var n = getVariant(e, t);
            ...
            defineFunctionBuilders({
                type: "mathord",
                htmlBuilder: (e, t) => eu.makeOrd(e, t, "mathord"),
                mathmlBuilder(e, t) {
                    var r = new eA.MathNode("mi", [makeText(e.text, e.mode, t)]),
                        n = getVariant(e, t) || "italic";
                    return n !== e6[r.type] && r.setAttribute("mathvariant", n), r
                }
            }), defineFunctionBuilders({
                type: "textord",
                htmlBuilder: (e, t) => eu.makeOrd(e, t, "textord"),
                mathmlBuilder(e, t) {
                    var r, n = makeText(e.text, e.mode, t),
                        a = getVariant(e, t) || "normal";
                    return a !== e6[(r = "text" === e.mode ? new eA.MathNode("mtext", [n]) : /[0-9]/.test(e.text) ? new eA.MathNode("mn", [n]) : "\\prime" === e.text ? new eA.MathNode("mo", [n]) : new eA.MathNode("mi", [n])).type] && r.setAttribute("mathvariant", a), r
                }
            });
            var e7 = {
                    "\\nobreak": "nobreak",
            ...
            defineFunctionBuilders({
                type: "spacing",
                htmlBuilder(e, t) {
                    if (e3.hasOwnProperty(e.text)) {
                        var r = e3[e.text].className || "";
                        if ("text" !== e.mode) return eu.makeSpan(["mspace", r], [eu.mathsym(e.text, e.mode, t)], t);
                        var n = eu.makeOrd(e, t, "textord");
                        return n.classes.push(r), n
                    }
                    if (e7.hasOwnProperty(e.text)) return eu.makeSpan(["mspace", e7[e.text]], [], t);
                    throw new ParseError('Unknown type of space "' + e.text + '"')
                },
                mathmlBuilder(e, t) {
                    var r;
                    if (e3.hasOwnProperty(e.text)) r = new eA.MathNode("mtext", [new eA.TextNode("\xa0")]);
                    else if (e7.hasOwnProperty(e.text)) return new eA.MathNode("mspace");
                    else throw new ParseError('Unknown type of space "' + e.text + '"');
                    return r
                }
            });
            var pad = () => {
                var e = new eA.MathNode("mtd", []);
                return e.setAttribute("width", "50%"), e
            };
            defineFunctionBuilders({
                type: "tag",
                mathmlBuilder(e, t) {
                    var r = new eA.MathNode("mtable", [new eA.MathNode("mtr", [pad(), new eA.MathNode("mtd", [buildExpressionRow(e.body, t)]), pad(), new eA.MathNode("mtd", [buildExpressionRow(e.tag, t)])])]);
            ...
            var e8 = {
                ...
                optionsWithFont = (e, t) => {
                    var r = e.font;
                    return r ? e8[r] ? t.withTextFontFamily(e8[r]) : e2[r] ? t.withTextFontWeight(e2[r]) : t.withTextFontShape(e9[r]) : t
                };
            defineFunction({
                type: "text",
                ...
                htmlBuilder(e, t) {
                    var r = optionsWithFont(e, t),
                        n = buildExpression$1(e.body, r, !0);
                    return eu.makeSpan(["mord", "text"], n, r)
                },
                mathmlBuilder(e, t) {
                    var r = optionsWithFont(e, t);
                ...
                htmlBuilder(e, t) {
                    var r = buildGroup$1(e.body, t),
                        n = eu.makeLineSpan("underline-line", t),
                        a = t.fontMetrics().defaultRuleThickness,
                        i = eu.makeVList({
                            positionType: "top",
                            positionData: r.height,
                    ...
                    return eu.makeSpan(["mord", "underline"], [i], t)
                },
                mathmlBuilder(e, t) {
                    var r = new eA.MathNode("mo", [new eA.TextNode("‾")]);
                    r.setAttribute("stretchy", "true");
                    var n = new eA.MathNode("munder", [buildGroup(e.body, t), r]);
                    return n.setAttribute("accentunder", "true"), n
                }
            }), defineFunction({
                type: "vcenter",
                ...
                mathmlBuilder: (e, t) => new eA.MathNode("mpadded", [buildGroup(e.body, t)], ["vcenter"])
            }), defineFunction({
                type: "verb",
                names: ["\\verb"],
                props: {
                ...
                htmlBuilder(e, t) {
                    for (var r = makeVerb(e), n = [], a = t.havingStyle(t.style.text()), i = 0; i < r.length; i++) {
                        var o = r[i];
                        "~" === o && (o = "\\textasciitilde"), n.push(eu.makeSymbol(o, "Typewriter-Regular", e.mode, a, ["mord", "texttt"]))
                    }
                    return eu.makeSpan(["mord", "text"].concat(a.sizingClasses(t)), eu.tryCombineChars(n), a)
                },
                mathmlBuilder(e, t) {
                    var r = new eA.TextNode(makeVerb(e)),
                        n = new eA.MathNode("mtext", [r]);
                    return n.setAttribute("mathvariant", "monospace"), n
                }
            });
            var makeVerb = e => e.body.replace(/ /g, e.star ? "␣" : "\xa0"),
                te = "[ \r\n	]",
                tt = "[̀-ͯ]",
                tr = RegExp(tt + "+$"),
                tn = "(" + te + "+)|\\\\(\n|[ \r	]+\n?)[ \r	]*|([!-\\[\\]-‧‪-퟿豈-￿]" + tt + "*|[\uD800-\uDBFF][\uDC00-\uDFFF]" + tt + "*|\\\\verb\\*([^]).*?\\4|\\\\verb([^*a-zA-Z]).*?\\5|(\\\\[a-zA-Z@]+)" + te + "*|\\\\[^\uD800-\uDFFF])";
            let Lexer = class Lexer {
                constructor(e, t) {
                    this.input = void 0, this.settings = void 0, this.tokenRegex = void 0, this.catcodes = void 0, this.input = e, this.settings = t, this.tokenRegex = RegExp(tn, "g"), this.catcodes = {
                        "%": 14,
                        "~": 13
                    }
                }
                ...
                lex() {
                    ...
                    if (14 === this.catcodes[n]) {
                        ...
                        return -1 === a ? (this.tokenRegex.lastIndex = e.length, this.settings.reportNonstrict("commentAtEnd", "% comment has no terminating newline; LaTeX would fail because of commenting the end of math mode (e.g. $)")) : this.tokenRegex.lastIndex = a + 1, this.lex()
                    }
            ...
            }, ej["\\expandafter"] = function(e) {
                var t = e.popToken();
                return e.expandOnce(!0), {
                    tokens: [t],
                    numArgs: 0
                }
            }, ej["\\@firstoftwo"] = function(e) {
                return {
                    tokens: e.consumeArgs(2)[0],
                    numArgs: 0
                }
            }, ej["\\@secondoftwo"] = function(e) {
                return {
                    tokens: e.consumeArgs(2)[1],
                    numArgs: 0
                }
            }, ej["\\@ifnextchar"] = function(e) {
            ...
            }, ej["\\@ifstar"] = "\\@ifnextchar *{\\@firstoftwo{#1}}", ej["\\TextOrMath"] = function(e) {
            ...
            ej["\\char"] = function(e) {
                var t, r, n = e.popToken(),
                    a = "";
                if ("'" === n.text) t = 8, n = e.popToken();
                else if ('"' === n.text) t = 16, n = e.popToken();
                else if ("`" === n.text) {
                    if ("\\" === (n = e.popToken()).text[0]) a = n.text.charCodeAt(1);
                    else if ("EOF" === n.text) throw new ParseError("\\char` missing argument");
                    else a = n.text.charCodeAt(0)
                } else t = 10;
                if (t) {
                    if (null == (a = ta[n.text]) || a >= t) throw new ParseError("Invalid base-" + t + " digit " + n.text);
                    for (; null != (r = ta[e.future().text]) && r < t;) a *= t, a += r, e.popToken()
                }
                return "\\@char{" + a + "}"
            };
            var newcommand = (e, t, r) => {
                var n = e.consumeArg().tokens;
                if (1 !== n.length) throw new ParseError("\\newcommand's first argument must be a macro name");
                var a = n[0].text,
                    i = e.isDefined(a);
                if (i && !t) throw new ParseError("\\newcommand{" + a + "} attempting to redefine " + a + "; use \\renewcommand");
                if (!i && !r) throw new ParseError("\\renewcommand{" + a + "} when command " + a + " does not yet exist; use \\newcommand");
                var o = 0;
                if (1 === (n = e.consumeArg().tokens).length && "[" === n[0].text) {
                    for (var l = "", s = e.expandNextToken();
                        "]" !== s.text && "EOF" !== s.text;) l += s.text, s = e.expandNextToken();
            ...
            ej["\\dots"] = function(e) {
                ...
                return r in ti ? t = ti[r] : "\\not" === r.slice(0, 4) ? t = "\\dotsb" : r in q.math && s.contains(["bin", "rel"], q.math[r].group) && (t = "\\dotsb"), t
            };
            var to = {
                ")": !0,
                "]": !0,
            ...
            var braketHelper = e => t => {
                ...
                t.macros.beginGroup();
                var midMacro = t => r => {
                    e && (r.macros.set("|", o), a.length && r.macros.set("\\|", l));
                    var i = t;
            ...
            let MacroExpander = class MacroExpander {
                constructor(e, t, r) {
                    this.settings = void 0, this.expansionCount = void 0, this.lexer = void 0, this.macros = void 0, this.stack = void 0, this.mode = void 0, this.settings = t, this.expansionCount = 0, this.feed(e), this.macros = new Namespace(ej, t.macros), this.mode = r, this.stack = []
                }
                feed(e) {
                ...
                scanArgument(e) {
                    ...
                    return this.pushToken(new Token("EOF", r.loc)), this.pushTokens(n), t.range(r, "")
                }
                consumeSpaces() {
                    for (;;)
                ...
                consumeArg(e) {
                    ...
                    var a = this.future(),
                        ...
                        o = 0;
                    do {
                        if (t = this.popToken(), r.push(t), "{" === t.text) ++i;
                        else if ("}" === t.text) {
                            if (-1 == --i) throw new ParseError("Extra }", t)
                        } else if ("EOF" === t.text) throw new ParseError("Unexpected end of input in a macro argument, expected '" + (e && n ? e[o] : "}") + "'", t);
                        if (e && n) {
                            if ((0 === i || 1 === i && "{" === e[o]) && t.text === e[o]) {
                                if (++o === e.length) {
                                    r.splice(-o, o);
                                    break
                                }
                ...
                consumeArgs(e, t) {
                    if (t) {
                        ...
                        for (var r = t[0], n = 0; n < r.length; n++) {
                            var a = this.popToken();
                            if (r[n] !== a.text) throw new ParseError("Use of the macro doesn't match its definition", a)
                        }
                    }
                ...
                expandOnce(e) {
                    ...
                    if (this.expansionCount++, this.expansionCount > this.settings.maxExpand) throw new ParseError("Too many expansions: infinite loop or need to increase maxExpand setting");
                    var a = n.tokens,
                        i = this.consumeArgs(n.numArgs, n.delimiters);
                    if (n.numArgs) {
                        a = a.slice();
                        for (var o = a.length - 1; o >= 0; --o) {
                            ...
                            if ("#" === l.text) {
                                ...
                                if ("#" === (l = a[--o]).text) a.splice(o + 1, 1);
                                else if (/^[1-9]$/.test(l.text)) a.splice(o, 2, ...i[+l.text - 1]);
                ...
                _getExpansion(e) {
                    ...
                    if ("string" == typeof n) {
                        ...
                        for (var o = new Lexer(n, this.settings), l = [], s = o.lex();
                ...
                isDefined(e) {
                    return this.macros.has(e) || ev.hasOwnProperty(e) || q.math.hasOwnProperty(e) || q.text.hasOwnProperty(e) || ts.hasOwnProperty(e)
                }
                isExpandable(e) {
                    var t = this.macros.get(e);
                    return null != t ? "string" == typeof t || "function" == typeof t || !t.unexpandable : ev.hasOwnProperty(e) && !ev[e].primitive
                }
            };
            var tm = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/,
                th = Object.freeze({
                    "₊": "+",
                    "₋": "-",
                    "₌": "=",
            ...
            let Parser = class Parser {
                ...
                parseExpression(e, t) {
                    for (var r = [];;) {
                        ...
                        var n = this.fetch();
                        if (-1 !== Parser.endOfExpression.indexOf(n.text) || t && n.text === t || e && ev[n.text] && ev[n.text].infix) break;
                ...
                handleInfixNodes(e) {
                    for (var t = -1, r = 0; r < e.length; r++)
                        if ("infix" === e[r].type) {
                            if (-1 !== t) throw new ParseError("only one infix operator per group", e[r].token);
                            t = r, n = e[r].replaceWith
                        }
                    if (-1 === t || !n) return e;
                    var n, a, i, o = e.slice(0, t),
                        l = e.slice(t + 1);
                    return a = 1 === o.length && "ordgroup" === o[0].type ? o[0] : {
                        type: "ordgroup",
                        mode: this.mode,
                        body: o
                        ...
                        mode: this.mode,
                        body: l
                    }, ["\\\\abovefrac" === n ? this.callFunction(n, [a, e[t], i], []) : this.callFunction(n, [a, i], [])]
                }
                handleSupSubscript(e) {
                    ...
                    if (!n) throw new ParseError("Expected group after '" + r + "'", t);
                    return n
                }
                ...
                parseAtom(e) {
                    ...
                    for (;;) {
                        ...
                        if ("\\limits" === a.text || "\\nolimits" === a.text) {
                            ...
                            } else if (n && "operatorname" === n.type) n.alwaysHandleSupSub && (n.limits = "\\limits" === a.text);
                            else throw new ParseError("Limit controls must follow a math operator", a);
                            this.consume()
                        } else if ("^" === a.text) {
                            if (t) throw new ParseError("Double superscript", a);
                            t = this.handleSupSubscript("superscript")
                        } else if ("_" === a.text) {
                            if (r) throw new ParseError("Double subscript", a);
                            ...
                            for (this.consume();;) {
                                ...
                                if (!th[h] || tm.test(h) !== m) break;
                                this.consume(), s += th[h]
                            }
                            var d = new Parser(s, this.settings).parse();
                            m ? r = {
                                type: "ordgroup",
                                mode: "math",
                                body: d
                ...
                parseFunction(e, t) {
                    var r = this.fetch(),
                        ...
                        a = ev[n];
                    if (!a) return null;
                    if (this.consume(), t && "atom" !== t && !a.allowedInArgument) throw new ParseError("Got function '" + n + "' with no arguments" + (t ? " as " + t : ""), r);
                    if ("text" !== this.mode || a.allowedInText) {
                        if ("math" === this.mode && !1 === a.allowedInMath) throw new ParseError("Can't use function '" + n + "' in math mode", r)
                    } else throw new ParseError("Can't use function '" + n + "' in text mode", r);
                    var {
                        args: i,
                        optArgs: o
                    } = this.parseArguments(n, a);
                    return this.callFunction(n, i, o, r, e)
                }
                callFunction(e, t, r, n, a) {
                    var i = ev[e];
                    if (i && i.handler) return i.handler({
                        funcName: e,
                        parser: this,
                        token: n,
                        breakOnTokenText: a
                ...
                parseArguments(e, t) {
                    ...
                    for (var n = [], a = [], i = 0; i < r; i++) {
                        ...
                        (t.primitive && null == o || "sqrt" === t.type && 1 === i && null == a[0]) && (o = "primitive");
                        var s = this.parseGroupOfType("argument to '" + e + "'", o, l);
                        if (l) a.push(s);
                        else if (null != s) n.push(s);
                ...
                parseStringGroup(e, t) {
                    var r, n = this.gullet.scanArgument(t);
                    if (null == n) return null;
                    for (var a = "";
                        "EOF" !== (r = this.fetch()).text;) a += r.text, this.consume();
                    return this.consume(), n.text = a, n
                }
                parseRegexGroup(e, t) {
                    for (var r, n = this.fetch(), a = n, i = "";
                        "EOF" !== (r = this.fetch()).text && e.test(i + r.text);) i += (a = r).text, this.consume();
                    if ("" === i) throw new ParseError("Invalid " + t + ": '" + n.text + "'", n);
                    return n.range(a, i)
                }
                parseColorGroup(e) {
                ...
                parseSizeGroup(e) {
                    ...
                    if (!validUnit(a)) throw new ParseError("Invalid unit: '" + a.unit + "'", t);
                    return {
                        type: "size",
                        mode: this.mode,
                        value: a,
                ...
                parseGroup(e, t) {
                    ...
                    if ("{" === a || "\\begingroup" === a) {
                        ...
                        var o = this.parseExpression(!1, i),
                            l = this.fetch();
                        this.expect(i), this.gullet.endGroup(), r = {
                            type: "ordgroup",
                            mode: this.mode,
                    ...
                    } else if (null == (r = this.parseFunction(t, e) || this.parseSymbol()) && "\\" === a[0] && !ts.hasOwnProperty(a)) {
                        if (this.settings.throwOnError) throw new ParseError("Undefined control sequence: " + a, n);
                        r = this.formatUnsupportedCmd(a), this.consume()
                    }
                    return r
                }
                formLigatures(e) {
                ...
                parseSymbol() {
                    ...
                    tc.hasOwnProperty(t[0]) && !q[this.mode][t[0]] && (this.settings.strict && "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e), t = tc[t[0]] + t.slice(1));
                    var a = tr.exec(t);
                    if (a && ("i" === (t = t.substring(0, a.index)) ? t = "ı" : "j" === t && (t = "ȷ")), q[this.mode][t]) {
                        this.settings.strict && "math" === this.mode && eo.indexOf(t) >= 0 && this.settings.reportNonstrict("unicodeTextInMathMode", 'Latin-1/Unicode text character "' + t[0] + '" used in math mode', e);
                        var i, o = q[this.mode][t].group,
                            l = SourceLocation.range(e);
                    ...
                    if (this.consume(), a)
                        for (var s = 0; s < a[0].length; s++) {
                            var m = a[0][s];
                            if (!td[m]) throw new ParseError("Unknown accent ' " + m + "'", e);
                            var h = td[m][this.mode] || td[m].text;
                            if (!h) throw new ParseError("Accent " + m + " unsupported in " + this.mode + " mode", e);
                            i = {
                                type: "accent",
                                mode: this.mode,
                                loc: SourceLocation.range(e),
            ...
            var parseTree = function(e, t) {
                ...
                render = function(e, t, r) {
                    t.textContent = "";
                    var n = renderToDomTree(e, r).toNode();
                    t.appendChild(n)
                };
            ...
            var renderError = function(e, t, r) {
                    if (r.throwOnError || !(e instanceof ParseError)) throw e;
                    var n = eu.makeSpan(["katex-error"], [new SymbolNode(t)]);
                ...
                renderToDomTree = function(e, t) {
                    ...
                    try {
                        var n = parseTree(e, r);
                        return buildTree(n, e, r)
                    } catch (t) {
                        return renderError(t, e, r)
                    }
                },
                tu = {
                    version: "0.16.9",
