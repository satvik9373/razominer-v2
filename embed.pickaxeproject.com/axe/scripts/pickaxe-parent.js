...
(function(undefined) {
    ...
    function setupIFrame(iframe, options) {
        ...
        // ensure has auto height
        if (!iframe.src.includes("height=auto")) {
            const prefix = iframe.src.includes("?") ? "&" : "?";
            iframe.src = iframe.src + `${prefix}height=auto`;
        }
    ...
    function factory() {
        ...
        return function iFrameResizeF(options, target) {
            ...
            options = {
                ...options,
                minHeight: options.minHeight ? options.minHeight : 200,
            };
