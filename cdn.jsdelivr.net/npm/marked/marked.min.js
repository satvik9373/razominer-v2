    ...
    class le {
        ...
        walkTokens(e, t) {
            ...
            for (const s of e) switch (n = n.concat(t.call(this, s)), s.type) {
                ...
                case "list":
                    {
                        const e = s;n = n.concat(this.walkTokens(e.items, t));
                        break
                    }
                default:
                    {
                        const e = s;this.defaults.extensions ? .childTokens ? .[e.type] ? this.defaults.extensions.childTokens[e.type].forEach((s => {
